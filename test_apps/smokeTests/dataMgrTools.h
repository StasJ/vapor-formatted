...
void PrintVariables(VAPoR::DataMgr &dataMgr, bool verbose = false, bool testVars = false);

int TestWRF(std::string &fileType, size_t memsize, size_t nthreads, std::vector<std::string> &files,
