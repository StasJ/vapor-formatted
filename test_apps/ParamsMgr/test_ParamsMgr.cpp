...
OptionParser::OptDescRec_T set_opts[] = {{"ifile", 1, "", "Construct Xml tree from a file"},
...
int main(int argc, char **argv) {
    ...
    TwoDDataParams *twoDparams0 = (TwoDDataParams *)pm->CreateRenderParamsInstance(
        "viz0", TwoDDataParams::GetClassType(), "twoD0");

    twoDparams0->SetVariableName("U10");
    twoDparams0->MakeTransferFunc("U10");

    TwoDDataParams *twoDparams1 = (TwoDDataParams *)pm->CreateRenderParamsInstance(
    ...
    ArrowParams *arrowParams0 =
        (ArrowParams *)pm->CreateRenderParamsInstance("viz0", ArrowParams::GetClassType(), "arrow");
