...
void InitializeOptions(int &argc, char **argv, OptionParser &op, std::vector<std::string> &files,
...
int TestWRF(std::vector<std::string> &files, std::vector<std::string> &options) {
