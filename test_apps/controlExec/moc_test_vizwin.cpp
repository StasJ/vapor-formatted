...
const QMetaObject VAPoR::Test_VizWin::staticMetaObject = {
    {&QGLWidget::staticMetaObject, qt_meta_stringdata_VAPoR__Test_VizWin,
     qt_meta_data_VAPoR__Test_VizWin, &staticMetaObjectExtraData}};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VAPoR::Test_VizWin::getStaticMetaObject() { return staticMetaObject; }
#endif // Q_NO_DATA_RELOCATION

const QMetaObject *VAPoR::Test_VizWin::metaObject() const {
...
void *VAPoR::Test_VizWin::qt_metacast(const char *_clname) {
    if (!_clname)
        return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VAPoR__Test_VizWin))
        return static_cast<void *>(const_cast<Test_VizWin *>(this));
