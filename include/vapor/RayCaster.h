...
class RENDER_API RayCaster : public Renderer {
  public:
    RayCaster(const ParamsMgr *pm, std::string &winName, std::string &dataSetName,
  ...
  protected:
    ...
    class UserCoordinates {
      ...
      public:
        ...
        void CheckUpToDateStatus(const RayCasterParams *params, const StructuredGrid *grid,
                                 DataMgr *dataMgr, bool use2ndVar);
        //
        // Update meta data, as well as pointers: 6 faces + dataField + missingValueMask
        //   It returns 0 upon success, and non-zero upon errors:
        //
        int UpdateFaceAndData(const RayCasterParams *params, const StructuredGrid *grid,
                              DataMgr *dataMgr);
        //
        ...
        // |-- It returns 0 upon success, and non-zero upon errors:
        //
        int UpdateVertCoords(const RayCasterParams *params, const StructuredGrid *grid,
                             DataMgr *dataMgr);
    ...
    void _drawVolumeFaces(int whichPass, int whichCastingMode,
                          const std::vector<size_t> &cameraCellIdx,
                          const glm::mat4 &inversedMV = glm::mat4(0.0f), bool fast = false) const;
