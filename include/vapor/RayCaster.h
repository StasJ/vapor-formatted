  ...
  protected:
    ...
    class UserCoordinates {
      ...
      public:
        ...
        bool IsMetadataUpToDate(const RayCasterParams *params, const StructuredGrid *grid,
        ...
        // |-- It returns 0 upon success, and non-zero upon errors:
        //
        int UpdateCurviCoords(const RayCasterParams *params, const StructuredGrid *grid,
                              DataMgr *dataMgr);
    ...
    void _drawVolumeFaces(int whichPass, int castingMode, bool insideACell = false,
