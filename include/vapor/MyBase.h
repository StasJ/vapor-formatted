...
COMMON_API std::vector<std::string> &SplitString(const std::string &s, char delim,
                                                 std::vector<std::string> &elems);
COMMON_API std::vector<size_t> &SplitString(const std::string &s, char delim,
                                            std::vector<size_t> &elems);
COMMON_API std::vector<int> &SplitString(const std::string &s, char delim, std::vector<int> &elems);
COMMON_API std::vector<float> &SplitString(const std::string &s, char delim,
                                           std::vector<float> &elems);
COMMON_API std::vector<double> &SplitString(const std::string &s, char delim,
...
//! \sa GetBits64()
//
COMMON_API unsigned long long SetBits64(unsigned long long targ, int pos, int n,
