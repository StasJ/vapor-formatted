...
class WASP_API WASP : public VAPoR::NetCDFCpp {
  public:
    ...
    //! InqDimsAtLevel()
    //
    virtual int InqVarDimlens(string name, int level, vector<size_t> &dims,
                              vector<size_t> &bs) const;
    ...
    //!
    virtual int InqVarCompressionParams(string name, string &wname, vector<size_t> &bs,
    ...
    //! \sa VarOpenRead()
    //
    static int InqDimsAtLevel(string wname, int level, vector<size_t> dims, vector<size_t> bs,
    ...
    //!
    static bool InqCompressionInfo(vector<size_t> bs, string wname, size_t &nlevels,
                                   size_t &maxcratio);
    ...
    //
    virtual int DefVar(string name, int xtype, vector<string> dimnames, string wname,
    ...
    //!
    virtual int DefVar(string name, int xtype, vector<string> dimnames, string wname,
                       vector<size_t> bs, vector<size_t> cratios, double missing_value);
  ...
  private:
    ...
    int _GetBlockAlignedDims(vector<string> dimnames, vector<size_t> bs, vector<string> &badimnames,
                             vector<size_t> &badims) const;

    int _GetCompressedDims(vector<string> dimnames, string wname, vector<size_t> bs,
    ...
    void _get_encoding_vectors(string wname, vector<size_t> bs, vector<size_t> cratios, int xtype,
                               vector<size_t> &ncoeffs, vector<size_t> &encoded_dims) const;

    bool _validate_compression_params(string wname, vector<size_t> dims, vector<size_t> bs,
                                      vector<size_t> cratios) const;

    bool _validate_put_vara_compressed(vector<size_t> start, vector<size_t> count,
                                       vector<size_t> bs, vector<size_t> udims,
                                       vector<size_t> cratios) const;

    bool _validate_get_vara_compressed(vector<size_t> start, vector<size_t> count,
                                       vector<size_t> bs, vector<size_t> udims,
                                       vector<size_t> cratios, bool unblock) const;

    int _get_compression_params(string name, vector<size_t> &bs, vector<size_t> &cratios,
                                vector<size_t> &udims, vector<size_t> &dims, string &wname) const;

    template <class T, class U>
    int _GetVara(vector<size_t> start, vector<size_t> count, bool unblock, T *data, U dummy);

    template <class T>
    int _GetVara(vector<size_t> start, vector<size_t> count, bool unblock_flag, T *data);

    static void _dims_at_level(vector<size_t> dims, vector<size_t> bs, int level, string wname,
                               vector<size_t> &dims_level, vector<size_t> &bs_level);

    static vector<string> mkmultipaths(string path, int n);

    template <class T, class U>
    int _PutVara(vector<size_t> start, vector<size_t> count, const T *data,
    ...
    template <class T>
    int _CopyHyperSlice(string varname, NetCDFCpp &src_ncdf, NetCDFCpp &dst_ncdf,
