...
class VDF_API Proj4API : public Wasp::MyBase {
  ...
  public:
    ...
    int Transform(string srcdef, string dstdef, double *x, double *y, double *z, size_t n,
                  int offset) const;
    int Transform(string srcdef, string dstdef, float *x, float *y, float *z, size_t n,
                  int offset) const;
  ...
  private:
    ...
    int _Transform(void *pjSrc, void *pjDst, double *x, double *y, double *z, size_t n,
                   int offset) const;

    int _Transform(void *pjSrc, void *pjDst, float *x, float *y, float *z, size_t n,
                   int offset) const;
};
}; // namespace VAPoR
