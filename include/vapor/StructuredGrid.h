...
class VDF_API StructuredGrid : public Grid {
  public:
    ...
    //!
    StructuredGrid(const std::vector<size_t> &dims, const std::vector<size_t> &bs,
    ...
    template <class T> class VDF_API ForwardIterator {
      public:
        ...
        friend void swap(StructuredGrid::ForwardIterator<T> &a,
    ...
    template <class T> class VDF_API ForwardCellIterator {
      public:
        ...
        friend void swap(StructuredGrid::ForwardCellIterator<T> &a,
    ...
    template <class T> class VDF_API ForwardNodeIterator {
      public:
        ...
        friend void swap(StructuredGrid::ForwardNodeIterator<T> &a,
  ...
  private:
    ...
    void _StructuredGrid(const std::vector<size_t> &dims, const std::vector<size_t> &bs,
                         const std::vector<float *> &blks);
};
}; // namespace VAPoR
#endif
