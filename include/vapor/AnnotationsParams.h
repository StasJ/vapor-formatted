...
//! a local AnnotationsParams for each window, that users can select whenever there are multiple
//! windows. When local settings are used, they only affect one currently active visualizer. The
//! AnnotationsParams class also has several methods that are useful in setting up data requests
//! from the DataMgr.
//!
