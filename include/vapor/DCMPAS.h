...
class VDF_API DCMPAS : public VAPoR::DC {
  public:
    ...
    virtual int GetVar(string varname, int, int, float *data) {
        return (DCMPAS::GetVar(varname, data));
    }
    ...
    virtual int GetVar(size_t ts, string varname, int, int, float *data) {
        return (DCMPAS::GetVar(ts, varname, data));
    }
  ...
  private:
    ...
    int _get_latlon_coordvars(NetCDFMPASCollection *ncdfc, string dvar, string &loncvar,
                              string &latcvar) const;

    int _get_latlon_extents(NetCDFMPASCollection *ncdfc, string latlon, bool lonflag, float &min,
                            float &max);

    int _get_coord_pair_extents(NetCDFMPASCollection *ncdfc, string lon, string lat, double &lonmin,
    ...
    int _InitHorizontalCoordinatesDerived(NetCDFMPASCollection *ncdfc,
    ...
    int _GetVarCoordinates(NetCDFMPASCollection *ncdfc, string varname, vector<string> &sdimnames,
    ...
    class DerivedVarHorizontal : public NetCDFCollection::DerivedVar {
      public:
        DerivedVarHorizontal(NetCDFMPASCollection *ncdfc, string lonname, string latname,
