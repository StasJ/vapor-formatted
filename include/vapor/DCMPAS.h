...
class VDF_API DCMPAS : public VAPoR::DC {
  ...
  private:
    ...
    class DerivedVarHorizontal : public NetCDFCollection::DerivedVar {
      public:
        DerivedVarHorizontal(NetCDFCollection *ncdfc, string lonname, string latname,
                             Proj4API *proj4API, bool lonflag, bool uGridFlag, bool degreesFlag);
    ...
    class DerivedVarVertical : public NetCDFCollection::DerivedVar {
      public:
        DerivedVarVertical(NetCDFCollection *ncdfc, string staggeredVarName,
    ...
    class DerivedVarWRFTime : public NetCDFCollection::DerivedVar {
      public:
        DerivedVarWRFTime(NetCDFCollection *ncdfc, const VAPoR::UDUnits *udunits,
                          string wrfTimeVar);
