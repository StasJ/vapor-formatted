...
class WASP_API MatWaveDwt : public MatWaveBase {
  ...
  public:
    ...
    int dwt2d(const double *sigIn, size_t sigInX, size_t sigInY, double *cA, double *cDh,
              double *cDv, double *cDd, size_t L[10]);
    int dwt2d(const float *sigIn, size_t sigInX, size_t sigInY, float *cA, float *cDh, float *cDv,
              float *cDd, size_t L[10]);
    ...
    int dwt2d(const long *sigIn, size_t sigInX, size_t sigInY, long *cA, long *cDh, long *cDv,
              long *cDd, size_t L[10]);
    int dwt2d(const int *sigIn, size_t sigInX, size_t sigInY, int *cA, int *cDh, int *cDv, int *cDd,
              size_t L[10]);
    ...
    int idwt2d(const double *cA, const double *cDh, const double *cDv, const double *cDd,
               const size_t L[10], double *sigOut);
    int idwt2d(const float *cA, const float *cDh, const float *cDv, const float *cDd,
    ...
    int idwt2d(const long *cA, const long *cDh, const long *cDv, const long *cDd,
               const size_t L[10], long *sigOut);
    int idwt2d(const int *cA, const int *cDh, const int *cDv, const int *cDd, const size_t L[10],
               int *sigOut);
    ...
    //! HLH, HHL, HHH
    //!
    int dwt3d(const double *sigIn, size_t sigInX, size_t sigInY, size_t sigInZ, double *C,
              size_t L[27]);
    int dwt3d(const float *sigIn, size_t sigInX, size_t sigInY, size_t sigInZ, float *C,
              size_t L[27]);

    int dwt3d(const long *sigIn, size_t sigInX, size_t sigInY, size_t sigInZ, long *C,
              size_t L[27]);
    ...
    int idwt3d(const double *cLLL, const double *cLLH, const double *cLHL, const double *cLHH,
               const double *cHLL, const double *cHLH, const double *cHHL, const double *cHHH,
               const size_t L[27], double *sigOut);
    int idwt3d(const float *cLLL, const float *cLLH, const float *cLHL, const float *cLHH,
    ...
    int idwt3d(const long *cLLL, const long *cLLH, const long *cLHL, const long *cLHH,
               const long *cHLL, const long *cHLH, const long *cHHL, const long *cHHH,
               const size_t L[27], long *sigOut);
    int idwt3d(const int *cLLL, const int *cLLH, const int *cLHL, const int *cLHH, const int *cHLL,
               const int *cHLH, const int *cHHL, const int *cHHH, const size_t L[27], int *sigOut);
