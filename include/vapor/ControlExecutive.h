...
class RENDER_API ControlExec : public MyBase {
  public:
    ...
    //! \sa ParamsMgr();
    //
    ControlExec(std::vector<string> appParamsNames = std::vector<string>(),
    ...
    //
    void SetNumThreads(size_t nthreads) { _dataStatus->SetNumThreads(nthreads); }

    size_t GetNumThreads() const { return (_dataStatus->GetNumThreads()); }
    ...
    //! \sa DataMgr
    //
    void SetCacheSize(size_t sizeMB) { _dataStatus->SetCacheSize(sizeMB); }
    ...
    //
    int ActivateRender(string winName, string dataSetName, string renderType, string renderName,
                       bool on);

    int ActivateRender(string winName, string dataSetName, const RenderParams *rp,
    ...
    //
    int OpenData(const std::vector<string> &files, const std::vector<string> &options,
    ...
    //! with the specified
    //
    RenderParams *GetRenderParams(string winName, string dataSetName, string renderType,
    ...
    //! \sa ActivateRender
    //
    bool RenderLookup(string instName, string &winName, string &dataSetName,
                      string &rendererType) const;
    ...
    //
    int DrawText(string winName, string text, int x, int y, int size, float color[3],
                 float backgroundColor[3], int type = 0);
    ...
    //
    int DrawText(string text, int x, int y, int size, float color[3], float bgColor[3],
                 int type = 0);
