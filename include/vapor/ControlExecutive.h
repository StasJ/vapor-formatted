...
class RENDER_API ControlExec : public MyBase {
  public:
    ...
    int AddFunction(string scriptType, string datasetName, string name, string script,
    ...
    bool GetFunction(string scriptType, string datasetName, string name, string &script,
