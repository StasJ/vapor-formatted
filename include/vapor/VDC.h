...
class VDF_API VDC : public VAPoR::DC {
  public:
    ...
    //
    void GetCompressionBlock(std::vector<size_t> &bs, string &wname,
                             std::vector<size_t> &cratios) const;
    ...
    void SetPeriodicBoundary(std::vector<bool> periodic) {
        _periodic = periodic;
        for (int i = _periodic.size(); i < 3; i++)
    ...
    //
    int DefineCoordVar(string varname, std::vector<string> dimnames, string time_dim_name,
    ...
    //! \sa DefineDimension(), DefineCoordVar(), SetCompressionBlock()
    //
    int DefineCoordVarUniform(string varname, std::vector<string> dimname, string time_dim_name,
                              string units, int axis, XType type, bool compressed);
    ...
    //!
    bool GetCoordVarInfo(string varname, std::vector<string> &dimnames, bool &time_varying,
                         string &units, int &axis, XType &type, bool &compressed,
                         bool &uniform) const;
    ...
    //! \sa DefineDimension(), DefineCoordVar(), SetCompressionBlock()
    //!
    int DefineDataVar(string varname, std::vector<string> dimnames, std::vector<string> coordvars,
    ...
    //! \sa DefineCoordVar(), DefineCoordVarUniform()
    //!
    bool GetDataVarInfo(string varname, std::vector<string> &dimnames,
                        std::vector<string> &coordvars, bool &time_varying, string &units,
                        XType &type, bool &compressed, string &maskvar) const;
    ...
    //!
    virtual bool CompressionInfo(vector<size_t> bs, string wname, size_t &nlevels,
                                 size_t &maxcratio) const = 0;
  ...
  protected:
    ...
    bool _ValidDefineCoordVar(string varname, vector<string> dimnames, string time_dim_name,
                              string units, int axis, XType type, bool compressed) const;

    bool _valid_blocking(const vector<DC::Dimension> &dimensions, const vector<size_t> &bs,
                         const vector<string> &coordvars) const;

    bool _valid_mask_var(string varname, vector<DC::Dimension> dimensions, vector<size_t> bs,
                         bool compressed, string maskvar) const;

    bool _ValidDefineDataVar(string varname, vector<string> dimnames, vector<string> coordnames,
    ...
    bool _valid_dims(const vector<DC::Dimension> &dims0, const vector<size_t> &bs0,
    ...
    int _DefineDataVar(string varname, std::vector<string> dimnames, std::vector<string> coordvars,
    ...
    int _DefineImplicitCoordVars(vector<string> dim_names, vector<string> coord_vars_in,
