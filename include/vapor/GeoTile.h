...
class RENDER_API GeoTile {
  ...
  public:
    ...
    //!
    GeoTile(size_t tile_width, size_t tile_height, size_t pixelsize, double min_lon, double min_lat,
    ...
    //! \sa PixelXYToLatLong()
    //
    virtual void LatLongToPixelXY(double lon, double lat, int lod, size_t &pixelX,
                                  size_t &pixelY) const = 0;
    ...
    //! \sa LatLongToPixelXY()
    //!
    virtual void PixelXYToLatLon(size_t pixelX, size_t pixelY, int lod, double &lon,
                                 double &lat) const = 0;
    ...
    //! in the tile's local coordinate system.
    //!
    void PixelXYToTileXY(size_t pixelX, size_t pixelY, size_t &tileX, size_t &tileY,
    ...
    //
    int GetMap(size_t pixelX0, size_t pixelY0, size_t pixelX1, size_t pixelY1, int lod,
    ...
    //! \param[out] ny Height of the map in pixels
    //
    int MapSize(size_t pixelX0, size_t pixelY0, size_t pixelX1, size_t pixelY1, int lod, size_t &nx,
                size_t &ny) const;
  ...
  private:
    ...
    void _CopyTileToMap(const unsigned char *tile, size_t tilePixelX0, size_t tilePixelY0,
                        size_t tilePixelX1, size_t tilePixelY1, unsigned char *map, size_t pixelX0,
                        size_t pixelX1, size_t nx, size_t ny) const;
