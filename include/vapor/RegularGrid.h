...
class VDF_API RegularGrid : public StructuredGrid {
  public:
    ...
    //!
    RegularGrid(const size_t bs[3], const size_t min[3], const size_t max[3],
    ...
    //!
    //
    RegularGrid(const std::vector<size_t> &bs, const std::vector<size_t> &min,
    ...
    //!
    virtual void GetIJKIndexFloor(double x, double y, double z, size_t *i, size_t *j,
                                  size_t *k) const;
