...
#define PERF_TIMER_DELTA                                                                           \
    ((PERF_TIMER_T2.tv_usec - PERF_TIMER_T1.tv_usec) / 1000000.0 +                                 \
     (double)(PERF_TIMER_T2.tv_sec - PERF_TIMER_T1.tv_sec))
#endif
...
// void PRINTARG(const VAPoR::VDC::AccessMode x) { printf("VDC::AccessMode::%s",
// x==VAPoR::VDC::AccessMode::R?"R":x==VAPoR::VDC::AccessMode::W?"W":"A"); } void PRINTARG(const
// VAPoR::DC::XType x)
// {
// 	switch (x) {
...
#define _PRINTARGS(n, ...) _CONCAT(PRINTARGS_, n)(__VA_ARGS__)
