...
class RENDER_API GeoTileMercator : public GeoTile {
  public:
    ...
    GeoTileMercator(size_t tile_width, size_t tile_height, size_t pixelsize)
        : GeoTile(tile_width, tile_height, pixelsize, -180.0, -85.05112878, 180.0, 85.05112878) {}

    GeoTileMercator(size_t tile_width, size_t tile_height, size_t pixelsize, double min_lon,
