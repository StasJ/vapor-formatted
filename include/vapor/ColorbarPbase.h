...
//! The ColorbarPbase class is a ParamsBase class that manages the settings associated with a color
//! bar. There is a corresponding ColorbarFrame class in the GUI that manages display of these
//! settings.
//!
//!
//!
