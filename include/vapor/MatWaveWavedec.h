...
class WASP_API MatWaveWavedec : public MatWaveDwt {
  ...
  public:
    ...
    //
    int wavedec3(const double *sigIn, size_t sigInX, size_t sigInY, size_t sigInZ, int n, double *C,
                 size_t *L);
    int wavedec3(const float *sigIn, size_t sigInX, size_t sigInY, size_t sigInZ, int n, float *C,
                 size_t *L);
    int wavedec3(const long *sigIn, size_t sigInX, size_t sigInY, size_t sigInZ, int n, long *C,
                 size_t *L);
    int wavedec3(const int *sigIn, size_t sigInX, size_t sigInY, size_t sigInZ, int n, int *C,
                 size_t *L);
    ...
    //
    void approxlength3(const size_t *L, int n, int l, size_t *lenx, size_t *leny,
                       size_t *lenz) const;
