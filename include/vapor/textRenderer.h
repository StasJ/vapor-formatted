...
class RENDER_API TextObject {
  public:
    ...
    int Initialize(string inFont, string inText, int inSize, double inCoords[3], TypeFlag inType,
                   double txtColor[4], double bgColor[4], ViewpointParams *vpParams = NULL);
    ~TextObject();
