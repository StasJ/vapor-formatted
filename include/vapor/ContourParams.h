...
class PARAMS_API ContourParams : public RenderParams {
  public:
    ...
    int GetNumIsovalues() const { return (int)GetValueDouble(_numIsovaluesTag, 1.0); }

    void SetNumIsovalues(int num) { SetValueDouble(_numIsovaluesTag, "Number of isovalues", num); }
