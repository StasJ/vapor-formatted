...
class RENDER_API Manip {
  ...
  public:
    ...
    virtual int mouseIsOverHandle(double screenCoords[2], double *boxExtents,
                                  double handleMid[3]) = 0;
...
//! Subclass of TranslateStretchManip that allows the box to be rotated, and for it to be slid
//! outside the full domain bounds.
