...
class VDF_API DataMgr : public Wasp::MyBase {
  ...
  private:
    ...
    VAPoR::Grid *_make_grid(int level, int lod, const VAPoR::DC::DataVar &var,
    ...
    float *_get_region_from_cache(size_t ts, string varname, int level, int lod,
                                  const std::vector<size_t> &bmin, const std::vector<size_t> &bmax,
                                  bool lock);

    float *_get_region_from_fs(size_t ts, string varname, int level, int lod,
                               const std::vector<size_t> &bs, const std::vector<size_t> &bmin,
                               const std::vector<size_t> &bmax, bool lock);

    float *_get_region(size_t ts, string varname, int level, int nlevels, int lod, int nlods,
                       const std::vector<size_t> &bs, const std::vector<size_t> &bmin,
                       const std::vector<size_t> &bmax, bool lock);
    ...
    float *_alloc_region(size_t ts, string varname, int level, int lod, std::vector<size_t> bmin,
                         std::vector<size_t> bmax, std::vector<size_t> bs, int element_sz,
                         bool lock, bool fill);
