...
#define DUMMIES
    ...
    void GetEnclosingRegion(size_t ts, double minu[3], double maxu[3], size_t min[3], size_t max[3],
    ...
    //
    VAPoR::StructuredGrid *GetVariable(size_t ts, string varname, int level, int lod,
                                       bool lock = false);
  ...
  private:
    ...
    VAPoR::StructuredGrid *_getVariable(size_t ts, string varname, int level, int lod,
