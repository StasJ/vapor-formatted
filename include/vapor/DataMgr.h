...
class VDF_API DataMgr : public Wasp::MyBase {
  ...
  private:
    ...
    void _setupCoordVecsHelper(string data_varname, const vector<size_t> &data_bmin,
                               const vector<size_t> &data_bmax, string coord_varname, int order,
    ...
    int _setupCoordVecs(size_t ts, string varname, int level, int lod, const vector<size_t> &min,
                        ...
                        vector<size_t> &roi_dims, vector<size_t> &dims,
    ...
    template <typename T>
    int _get_region_from_fs_helper(size_t ts, string varname, int level, int lod,
                                   const vector<size_t> &file_bmin, const vector<size_t> &file_bmax,
    ...
    T *_get_region_from_fs(size_t ts, string varname, int level, int lod,
                           const std::vector<size_t> &grid_bs, const std::vector<size_t> &grid_bmin,
                           const std::vector<size_t> &grid_bmax, bool lock);

    template <typename T>
    T *_get_region(size_t ts, string varname, int level, int nlevels, int lod, int nlods,
                   const std::vector<size_t> &bs, const std::vector<size_t> &bmin,
