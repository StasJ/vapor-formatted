...
class VDF_API DataMgr : public Wasp::MyBase {
  ...
  private:
    ...
    UnstructuredGrid2D *
    _make_grid_unstructured2d(int level, int lod, const DC::DataVar &dvarinfo,
    ...
    VAPoR::Grid *
    _make_grid(int level, int lod, const VAPoR::DC::DataVar &var,
    ...
    const KDTreeRG *_getKDTree2D(int level, int lod, const vector<DC::CoordVar> &cvarsinfo,
