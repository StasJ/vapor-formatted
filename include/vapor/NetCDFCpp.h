...
class WASP_API NetCDFCpp : public Wasp::MyBase {
  public:
    ...
    virtual int PutVara(string varname, vector<size_t> start, vector<size_t> count,
                        const void *data);
    virtual int PutVara(string varname, vector<size_t> start, vector<size_t> count,
                        const float *data);
    virtual int PutVara(string varname, vector<size_t> start, vector<size_t> count,
    ...
    virtual int GetVara(string varname, vector<size_t> start, vector<size_t> count,
                        void *data) const;
    virtual int GetVara(string varname, vector<size_t> start, vector<size_t> count,
                        float *data) const;
    virtual int GetVara(string varname, vector<size_t> start, vector<size_t> count,
  ...
  private:
    ...
    int _PutVara(string varname, vector<size_t> start, vector<size_t> count, const void *data,
                 string func);
    int _PutVar(string varname, const void *data, string func);

    int _GetVara(string varname, vector<size_t> start, vector<size_t> count, void *data,
                 string func) const;
