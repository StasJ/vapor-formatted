...
class VDF_API NetCDFSimple : public Wasp::MyBase {
    ...
    class Variable {
      public:
        ...
        VDF_API friend bool operator==(const Variable &v1, const Variable &v2) {
            return ((v1._name == v2._name) && (v1._dimnames == v2._dimnames) &&
                    (v1._flt_atts == v2._flt_atts) && (v1._int_atts == v2._int_atts) &&
                    (v1._str_atts == v2._str_atts) && (v1._type == v2._type));
        }
  ...
  private:
    ...
    int _GetAtts(int ncid, int varid, std::vector<std::pair<string, std::vector<double>>> &flt_atts,
