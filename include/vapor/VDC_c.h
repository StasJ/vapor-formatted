...
void VDCBaseVar_GetAttributeNames(const VDCBaseVar *p, char ***names,
                                  int *count); // Return names instead of objects
...
int VDC_DefineDataVar(VDC *p, const char *varname, const char **dimnames, size_t dimnamesCount,
                      const char **coordvars, size_t coordvarCount, const char *units,
