...
class VDF_API StretchedGrid : public RegularGrid {
  public:
    ...
    //! be uniform.
    //!
    StretchedGrid(const size_t bs[3], const size_t min[3], const size_t max[3],
    ...
    StretchedGrid(const size_t bs[3], const size_t min[3], const size_t max[3],
                  const double extents[6], const bool periodic[3], float **blks,
                  const std::vector<double> &xcoords, const std::vector<double> &ycoords,
                  const std::vector<double> &zcoords, float missing_value);
    ...
    //!
    void GetUserCoordinateMaps(std::vector<double> &xcoords, std::vector<double> &ycoords,
