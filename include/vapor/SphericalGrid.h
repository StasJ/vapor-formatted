...
class VDF_API SphericalGrid : public RegularGrid {
  public:
    ...
    //!
    SphericalGrid(const size_t bs[3], const size_t min[3], const size_t max[3],
                  const double extents[6], const size_t permutation[3], const bool periodic[3],
                  float **blks);
    ...
    SphericalGrid(const size_t bs[3], const size_t min[3], const size_t max[3],
                  const double extents[6], const size_t permutation[3], const bool periodic[3],
                  float **blks, float missing_value);
    ...
    //
    static inline void CartToSph(double x, double y, double z, double *phi, double *theta,
                                 double *r);

    static inline void SphToCart(double phi, double theta, double r, double *x, double *y,
                                 double *z);
  ...
  private:
    ...
    void _permute(const std::vector<long> &permutation, double result[3], double x, double y,
                  double z) const;
};
}; // namespace VAPoR
#endif
