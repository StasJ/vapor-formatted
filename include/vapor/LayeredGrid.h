...
class VDF_API LayeredGrid : public RegularGrid {
  public:
    ...
    //!
    LayeredGrid(const std::vector<size_t> &bs, const std::vector<size_t> &min,
                const std::vector<size_t> &max, const std::vector<double> &minu,
                const std::vector<double> &maxu, const std::vector<bool> &periodic,
                const std::vector<float *> &blks, const RegularGrid &rg);

#ifdef DEAD
    //! \deprecated This method is deprecated.
    //!
    LayeredGrid(const size_t bs[3], const size_t min[3], const size_t max[3],
                const double extents[6], const bool periodic[3], const std::vector<float *> &blks,
    ...
    LayeredGrid(const std::vector<size_t> &bs, const std::vector<size_t> &min,
                const std::vector<size_t> &max, const std::vector<double> &minu,
                const std::vector<double> &maxu, const std::vector<bool> &periodic,
                const std::vector<float *> &blks, const RegularGrid &rg, float missing_value);
    ...
    LayeredGrid(const size_t bs[3], const size_t min[3], const size_t max[3],
                const double extents[6], const bool periodic[3], const std::vector<float *> &blks,
                const RegularGrid &rg, float missing_value);
#endif
  ...
  private:
    ...
    void _layeredGrid(const std::vector<bool> &periodic, const std::vector<double> &minu,
    ...
    //
    void _getBilinearWeights(double x, double y, double z, double &iwgt, double &jwgt) const;
    ...
    double _bilinearElevation(size_t i0, size_t i1, size_t j0, size_t j1, size_t k0, double iwgt,
                              double jwgt) const;
    ...
    double _bilinearInterpolation(size_t i0, size_t i1, size_t j0, size_t j1, size_t k0,
                                  double iwgt, double jwgt) const;
    ...
    double _interpolateVaryingCoord(size_t i0, size_t j0, size_t k0, double x, double y,
                                    double z) const;
};
}; // namespace VAPoR
#endif
