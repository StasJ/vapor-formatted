  ...
  public:
    ...
    class Mesh {
      public:
        ...
        //!
        Mesh(std::string name, size_t max_nodes_per_face, std::string node_dim_name,
      ...
      private:
        ...
        void _Mesh(string name, std::vector<string> coord_vars, int max_nodes_per_face, Type type);
    };
