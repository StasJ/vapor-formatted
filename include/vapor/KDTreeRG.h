...
class VDF_API KDTreeRG {
  public:
    ...
    //! \sa RegularGrid()
    //
    KDTreeRG(const RegularGrid &xrg, const RegularGrid &yrg);
    ...
    //
    KDTreeRG(const RegularGrid &xrg, const RegularGrid &yrg, const RegularGrid &zrg);
    virtual ~KDTreeRG();
...
class VDF_API KDTreeRGSubset {
  public:
    ...
    //! until this class instance is destroyed.
    //
    KDTreeRGSubset(const KDTreeRG *kdtreerg, const std::vector<size_t> &min,
