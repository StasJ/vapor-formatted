...
class VDF_API DCWRF : public VAPoR::DC {
  ...
  private:
    ...
    DerivedVarHorizontal *_InitHorizontalCoordinatesHelper(NetCDFCollection *ncdfc,
                                                           Proj4API *proj4API, string name,
                                                           string fastest_dim, int axis,
                                                           vector<size_t> latlondims);

    int _InitHorizontalCoordinates(NetCDFCollection *ncdfc, Proj4API *proj4API);

    DCWRF::DerivedVarElevation *_InitVerticalCoordinatesHelper(NetCDFCollection *ncdfc, string name,
    ...
    bool _GetVarCoordinates(NetCDFCollection *ncdfc, string varname, std::vector<string> &dimnames,
                            std::vector<string> &coordvars, string &time_dim_name,
    ...
    class DerivedVarElevation : public VAPoR::NetCDFCollection::DerivedVar {
      public:
        DerivedVarElevation(NetCDFCollection *ncdfc, string name, const vector<DC::Dimension> &dims,
                            float grav);
    ...
    class DerivedVarHorizontal : public NetCDFCollection::DerivedVar {
      public:
        DerivedVarHorizontal(NetCDFCollection *ncdfc, string name,
                             const vector<DC::Dimension> &dims, const vector<size_t> latlondims,
                             Proj4API *proj4API);
    ...
    class DerivedVarTime : public NetCDFCollection::DerivedVar {
      public:
        DerivedVarTime(NetCDFCollection *ncdfc, DC::Dimension dims,
