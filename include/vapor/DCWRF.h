...
class VDF_API DCWRF : public VAPoR::DC {
  ...
  private:
    ...
    class WRFFileObject : public DC::FileTable::FileObject {
      public:
        WRFFileObject(size_t ts, string varname, int level, int lod, int fd, bool derivedFlag)
    ...
    DerivedCoordVar_CF2D *_makeDerivedHorizontalIdealized(NetCDFCollection *ncdfc, string name,
                                                          string &timeDimName,
                                                          vector<string> &spaceDimNames);

    DerivedCoordVar_Staggered *_makeDerivedHorizontalStaggered(NetCDFCollection *ncdfc, string name,
                                                               string &timeDimName,
                                                               vector<string> &spaceDimNames);
