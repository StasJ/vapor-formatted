...
class WASP_API Compressor : public MatWaveWavedec {
  public:
    ...
    int Compress(const double *src_arr, double *dst_arr, size_t dst_arr_len,
    ...
    //
    int Decompose(const float *src_arr, float *dst_arr, const vector<size_t> &dst_arr_lens,
                  vector<SignificanceMap> &sigmaps);
    int Decompose(const double *src_arr, double *dst_arr, const vector<size_t> &dst_arr_lens,
                  vector<SignificanceMap> &sigmaps);
    int Decompose(const int *src_arr, int *dst_arr, const vector<size_t> &dst_arr_lens,
                  vector<SignificanceMap> &sigmaps);
    int Decompose(const long *src_arr, long *dst_arr, const vector<size_t> &dst_arr_lens,
                  vector<SignificanceMap> &sigmaps);
    ...
    int Reconstruct(const double *src_arr, double *dst_arr, vector<SignificanceMap> &sigmaps,
                    int l);
    ...
    static bool CompressionInfo(vector<size_t> dims, const string wavename, bool keepapp,
