...
class RENDER_API BarbRenderer : public Renderer {
  ...
  private:
    ...
    void _setDefaultLengthAndThicknessScales(size_t ts, const std::vector<string> &varnames,
    ...
    void _getDirection(float direction[3], vector<Grid *> varData, float xCoord, float yCoord,
