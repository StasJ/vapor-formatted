...
class VDF_API UnstructuredGridCoordless : public UnstructuredGrid {
  public:
    ...
    //!
    //
    UnstructuredGridCoordless(const std::vector<size_t> &vertexDims,
    ...
    virtual void GetBoundingBox(const std::vector<size_t> &, const std::vector<size_t> &,
    ...
    bool GetEnclosingRegion(const std::vector<double> &, const std::vector<double> &,
