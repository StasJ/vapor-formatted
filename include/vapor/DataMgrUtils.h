...
//! for each variable
//
int GetGrids(DataMgr *dataMgr, size_t ts, const vector<string> &varnames,
...
int GetGrids(DataMgr *dataMgr, size_t ts, const vector<string> &varnames, bool useLowerAccuracy,
             int *refLevel, int *lod, std::vector<Grid *> &grids);
...
//! \sa GetAxes()
//
bool GetExtents(DataMgr *dataMgr, size_t timestep, string varname, vector<double> &minExts,
