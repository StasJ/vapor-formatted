...
//! \sa GetAxes()
//
VDF_API bool GetExtents(DataMgr *dataMgr, size_t timestep, string varname, vector<double> &minExts,
...
//!
//
VDF_API bool GetExtents(DataMgr *dataMgr, size_t timestep, int level,
                        const vector<string> &varnames, vector<double> &minExts,
                        vector<double> &maxExts);
