...
//
bool GetFirstExistingVariable(DataMgr *dataMgr, int level, int lod, int ndim, string &varname,
                              size_t &ts);
...
//! \sa DataMgr::VariableExists()
//
bool GetFirstExistingVariable(DataMgr *dataMgr, size_t ts, int level, int lod, int ndim,
                              string &varname);
