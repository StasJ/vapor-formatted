...
//
int CopyVar2d3dMask(DC &dc, VDC &vdc, const vector<size_t> &dimlens, size_t ts, string varname,
                    int lod) {
...
//
int CopyVar2d3d(DC &dc, VDC &vdc, const vector<size_t> &dimlens, size_t ts, string varname,
                int lod) {
    assert(dimlens.size() == 2 || dimlens.size() == 3);
...
//
int CopyVar0d1d(DC &dc, VDC &vdc, const vector<size_t> &dimlens, size_t ts, string varname,
                int lod) {
