...
int main(int argc, char **argv) {
    ...
    for (int i = 0; i < opt.vars3d.size(); i++) {
        rc = vdc.DefineDataVar(opt.vars3d[i], dimnames, dimnames, "", VDC::FLOAT, true);
    }
    for (int i = 0; i < opt.ncvars3d.size(); i++) {
        rc = vdc.DefineDataVar(opt.ncvars3d[i], dimnames, dimnames, "", VDC::FLOAT, false);
    }
    ...
    for (int i = 0; i < opt.vars2dxy.size(); i++) {
        rc = vdc.DefineDataVar(opt.vars2dxy[i], dimnames2dxy, dimnames2dxy, "", VDC::FLOAT, true);
    }
    for (int i = 0; i < opt.ncvars2dxy.size(); i++) {
        rc =
            vdc.DefineDataVar(opt.ncvars2dxy[i], dimnames2dxy, dimnames2dxy, "", VDC::FLOAT, false);
    }
    ...
    for (int i = 0; i < opt.vars2dxz.size(); i++) {
        rc = vdc.DefineDataVar(opt.vars2dxz[i], dimnames2dxz, dimnames2dxz, "", VDC::FLOAT, true);
    }
    for (int i = 0; i < opt.ncvars2dxz.size(); i++) {
        rc =
            vdc.DefineDataVar(opt.ncvars2dxz[i], dimnames2dxz, dimnames2dxz, "", VDC::FLOAT, false);
    }
    ...
    for (int i = 0; i < opt.vars2dyz.size(); i++) {
        rc = vdc.DefineDataVar(opt.vars2dyz[i], dimnames2dyz, dimnames2dyz, "", VDC::FLOAT, true);
    }
    for (int i = 0; i < opt.ncvars2dyz.size(); i++) {
        rc =
            vdc.DefineDataVar(opt.ncvars2dyz[i], dimnames2dyz, dimnames2dyz, "", VDC::FLOAT, false);
    }
