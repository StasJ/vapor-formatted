...
class StartupParams : public VAPoR::ParamsBase {
  ...
  public:
    ...
    bool GetAutoSaveSessionEnabled() const;
    void SetAutoSaveSessionEnabled(bool enabled);
  ...
  private:
    ...
    static const string _autoSaveSessionTag;
    static const string _changesPerAutoSaveTag;
    static const string _autoSaveFileLocation;
