...
void RenderHolder::getRow(int row, string &renderInst, string &renderClass, string &dataSetName,
    ...
    QCheckBox *checkbox = (QCheckBox *)widget->findChild<QCheckBox *>();
    ; // tableWidget->cellWidget(row,3);
    if (checkbox != NULL) {
...
void RenderHolder::setRow(int row, const string &renderInst, const string &renderClass,
    ...
    connect(pCheckBox, SIGNAL(stateChanged(int)), this, SLOT(checkboxChanged(int)));
}
