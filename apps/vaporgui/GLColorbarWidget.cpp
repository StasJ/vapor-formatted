...
//----------------------------------------------------------------------------
float GLColorbarWidget::width() { return right() - left(); }
...
void GLColorbarWidget::deleteSelectedControlPoint() {
    if (_colormap && selected() && _colormap->numControlPoints() > 2 && _selected != 0 &&
...
//----------------------------------------------------------------------------
float GLColorbarWidget::right() { return dataToWorld(_parent->maxDataValue()); }

//----------------------------------------------------------------------------
// Leftmost edge of colorbar in world coordinates
//----------------------------------------------------------------------------
float GLColorbarWidget::left() { return dataToWorld(_parent->minDataValue()); }
