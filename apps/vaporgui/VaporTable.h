...
class VaporTable : public QWidget {
  ...
  public:
    ...
    VaporTable(QTableWidget *table, bool lastRowIsCheckboxes = false,
               bool lastColIsCheckboxes = false);

    void Update(int rows, int columns, std::vector<int> values,
                std::vector<std::string> rowHeaders = std::vector<std::string>(),
                std::vector<std::string> colHeaders = std::vector<std::string>());
    void Update(int rows, int columns, std::vector<double> values,
                std::vector<std::string> rowHeaders = std::vector<std::string>(),
                std::vector<std::string> colHeaders = std::vector<std::string>());
    void Update(int rows, int columns, std::vector<std::string> values,
                std::vector<std::string> rowHeaders = std::vector<std::string>(),
                std::vector<std::string> colHeaders = std::vector<std::string>());
