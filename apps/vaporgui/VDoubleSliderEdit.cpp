...
VDoubleSliderEdit::VDoubleSliderEdit(double min, double max, double value, bool rangeChangable)
    : VSliderEditInterface(), _value(value), _rangeChangable(rangeChangable) {
    ...
    connect(_slider, &VSlider::ValueChangedIntermediate, this,
            &VDoubleSliderEdit::_sliderChangedIntermediate);
...
void VDoubleSliderEdit::_makeContextMenu() {
    _menu = new VDoubleRangeMenu(this, _lineEdit->GetSciNotation(), _lineEdit->GetNumDigits(),
                                 _slider->GetMinimum(), _slider->GetMaximum(), _rangeChangable);
    connect(_menu, &VNumericFormatMenu::DecimalDigitsChanged, this,
            &VDoubleSliderEdit::SetNumDigits);
    connect(_menu, &VNumericFormatMenu::SciNotationChanged, this,
            &VDoubleSliderEdit::SetSciNotation);
