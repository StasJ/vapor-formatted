...
PlotParams::PlotParams(ParamsBase::StateSave *ssave)
    : ParamsBase(ssave, PlotParams::GetClassType()) {}
...
void PlotParams::SetMinTS(int ts) {
    SetValueDouble(_minTSTag, "Minimum selected timestep for plot", (double)ts);
}
...
void PlotParams::SetMaxTS(int ts) {
    SetValueDouble(_maxTSTag, "Maximum selected timestep for plot", (double)ts);
}
...
void PlotParams::SetMinExtents(vector<double> minExts) {
    SetValueDoubleVec(_minExtentsTag, "Minimum extents for plot", minExts);
}
...
void PlotParams::SetMaxExtents(vector<double> maxExts) {
    SetValueDoubleVec(_maxExtentsTag, "Maximum extents for plot", maxExts);
}
