...
VDoubleRangeMenu::VDoubleRangeMenu(QWidget *parent, bool sciNotation, double decimalDigits,
                                   double min, double max, bool rangeChangable)
    ...
    connect(_minRangeAction, &VDoubleLineEditAction::ValueChanged, this,
            &VDoubleRangeMenu::_minChanged);
    addAction(_minRangeAction);

    connect(_maxRangeAction, &VDoubleLineEditAction::ValueChanged, this,
            &VDoubleRangeMenu::_maxChanged);
