...
void VizWinMgr::_attachVisualizer(string vizName) {
    ...
    connect(_vizWindow[vizName], SIGNAL(Closing(const string &)), this,
            SLOT(_vizAboutToDisappear(const string &)));
    connect(_vizWindow[vizName], SIGNAL(HasFocus(const string &)), this,
            SLOT(_setActiveViz(const string &)));

    connect(_vizWindow[vizName], SIGNAL(EndNavigation(const string &)), this,
            SLOT(_syncViewpoints(const string &)));
