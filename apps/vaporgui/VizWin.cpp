...
void VizWin::getUnionOfFieldVarExtents(RenderParams *rParams, DataMgr *dataMgr, int timeStep,
...
void VizWin::getCenterAndCamPos(std::vector<double> &rotationCenter,
...
void VizWin::updateManip(bool initialize) {
    ...
    _manip->Update(llc, urc, minExts, maxExts, cameraPosition, rotationCenter, mv, proj, windowSize,
                   rpTransform, dmTransform, constrain);
