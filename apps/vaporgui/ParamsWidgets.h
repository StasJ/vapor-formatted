...
class PSpinBox : public ParamsWidget {
  ...
  public:
    PSpinBox(QWidget *parent, const std::string &tag, const std::string &description,
             const std::string &label, int min = 0, int max = 100, int val = 0);
...
class PSlider : public ParamsWidget {
  ...
  public:
    PSlider(QWidget *parent, const std::string &tag, const std::string &description,
            const std::string &label, double min = 0, double max = 100, double val = 0);
...
class PRange : public ParamsWidget {
  ...
  public:
    PRange(QWidget *parent, const std::string &tag, const std::string &description, double min,
           double max, const std::string &minLabel = "Min", const std::string &maxLabel = "Max");
...
class PGeometry : public ParamsWidget {
  ...
  public:
    PGeometry(QWidget *parent, const std::string &tag, const std::string &description,
