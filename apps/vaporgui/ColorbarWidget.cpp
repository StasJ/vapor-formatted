...
void ColorbarWidget::connectWidgets() {
    connect(enableCheckbox, SIGNAL(stateChanged(int)), this, SLOT(enableDisable(int)));
    connect(titleEdit, SIGNAL(returnPressed()), this, SLOT(titleChanged()));
    connect(colorSelectButton, SIGNAL(pressed()), this, SLOT(setColor()));
    connect(bgSelectButton, SIGNAL(pressed()), this, SLOT(setBackgroundColor()));
    connect(_xPosCombo, SIGNAL(valueChanged(double)), this, SLOT(xPosChanged(double)));
    connect(_yPosCombo, SIGNAL(valueChanged(double)), this, SLOT(yPosChanged(double)));
    connect(_xSizeCombo, SIGNAL(valueChanged(double)), this, SLOT(xSizeChanged(double)));
    connect(_ySizeCombo, SIGNAL(valueChanged(double)), this, SLOT(ySizeChanged(double)));
    connect(_fontSizeCombo, SIGNAL(valueChanged(int)), this, SLOT(fontSizeChanged(int)));
    connect(_fontDigitsCombo, SIGNAL(valueChanged(int)), this, SLOT(fontDigitsChanged(int)));
    connect(_numTicksCombo, SIGNAL(valueChanged(int)), this, SLOT(numTicksChanged(int)));
}
...
void ColorbarWidget::fontSizeChanged(int fSize) { _cbPbase->SetFontSize(fSize); }

void ColorbarWidget::fontDigitsChanged(int digits) { _cbPbase->SetNumDigits(digits); }
