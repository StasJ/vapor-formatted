...
void VFidelitySection::Update(VAPoR::RenderParams *rParams, VAPoR::ParamsMgr *paramsMgr,
...
void VFidelityButtons::Reinit(VariableFlags varFlags) { _variableFlags = varFlags; }

void VFidelityButtons::Update(VAPoR::RenderParams *params, VAPoR::ParamsMgr *paramsMgr,
                              VAPoR::DataMgr *dataMgr) {
    VAssert(dataMgr);
    VAssert(paramsMgr);
    VAssert(params);
