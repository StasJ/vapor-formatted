...
class PythonVariables : public QDialog, Ui_PythonVariablesGUI {
  ...
  private slots:
    ...
    void _findEnabledCoordinateVariables(const std::vector<string> variables,
  ...
  private:
    ...
    void _makeInputTableValues(std::vector<string> &tableValuesCoords,
    ...
    bool _isGridSelected(string grid, std::vector<string> selectedVars,
...
class Fader : public QThread {
  ...
  public:
    Fader(bool fadeIn, QColor background, QColor textColor, QObject *parent = 0);
...
class NewItemDialog : public QDialog {
  ...
  public:
    ...
    void Update(int type, std::vector<string> optionNames,
