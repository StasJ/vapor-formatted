...
VariablesWidget2::VariablesWidget2() : VSection("Variable Selection") {
    // Add(
    layout()->addWidget(new PEnumDropdownHLI<VAPoR::RenderParams>(
        "Dimensionality HLI", {"2D", "3D"}, {2, 3}, &VAPoR::RenderParams::GetRefinementLevel,
    ...
    connect(_dimComboBox, &VComboBox::ValueChanged, this, &VariablesWidget2::_dimChanged);
