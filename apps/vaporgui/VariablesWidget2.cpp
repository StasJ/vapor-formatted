...
VariablesWidget2::VariablesWidget2() : PSection("Variable Selection") {
    Add(new PEnumDropdownHLI<VAPoR::RenderParams>("Dimensionality HLI", {"2D", "3D"}, {2, 3},
                                                  &VAPoR::RenderParams::GetRefinementLevel,
                                                  &VAPoR::RenderParams::SetRefinementLevel));
    _dimDropdown =
        new new PEnumDropdown("", {"2D", "3D"}, {2, 3}, "Dimensionality") Add(_dimDropdown);

    // No signals from PWidgets?!
    // connect( _dimDropdown,
    Add(new PVariableSelectorHLI<VAPoR::RenderParams>("Variable Name",
    ...
    Add(new PVariableSelectorHLI<VAPoR::RenderParams>("   X",
                                                      &VAPoR::RenderParams::GetXFieldVariableName,
                                                      &VAPoR::RenderParams::SetXFieldVariableName));
    Add(new PVariableSelectorHLI<VAPoR::RenderParams>("   Y",
                                                      &VAPoR::RenderParams::GetXFieldVariableName,
                                                      &VAPoR::RenderParams::SetXFieldVariableName));
    Add(new PVariableSelectorHLI<VAPoR::RenderParams>("   Z",
                                                      &VAPoR::RenderParams::GetXFieldVariableName,
                                                      &VAPoR::RenderParams::SetXFieldVariableName));
}

void VariablesWidget2::Reinit(VariableFlags varFlags, DimFlags dimFlags) {}
