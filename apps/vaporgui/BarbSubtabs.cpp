...
BarbAppearanceSubtab::BarbAppearanceSubtab(QWidget *parent) {
    ...
    this->tab->layout()->addWidget(
        _colorByVarCheckbox =
            new ParamsWidgetCheckbox(VAPoR::RenderParams::_useSingleColorTag, "Use Single Color"));
    this->tab->layout()->addWidget(_constantColorSelector = new ParamsWidgetColor(
                                       VAPoR::RenderParams::_constantColorTag, "Constant Color"));
...
void BarbAppearanceSubtab::Update(VAPoR::DataMgr *dataMgr, VAPoR::ParamsMgr *paramsMgr,
