...
VIntSliderEdit::VIntSliderEdit(int min, int max, int value, bool rangeChangable)
    ...
    connect(_slider, &VSlider::ValueChangedIntermediate, this,
            &VIntSliderEdit::_sliderChangedIntermediate);
...
void VIntSliderEdit::_makeContextMenu() {
    _menu = new VIntRangeMenu(this, _lineEdit->GetSciNotation(), _lineEdit->GetNumDigits(),
