...
void VaporTable::Update(int rows, int cols, std::vector<int> values,
                        std::vector<std::string> rowHeaders, std::vector<std::string> colHeaders) {

    std::vector<std::string> sValues = convertToString(values);
    Update(rows, cols, sValues, rowHeaders, colHeaders);
}

void VaporTable::Update(int rows, int cols, std::vector<double> values,
                        std::vector<std::string> rowHeaders, std::vector<std::string> colHeaders) {
...
void VaporTable::Update(int rows, int cols, std::vector<std::string> values,
                        std::vector<std::string> rowHeaders, std::vector<std::string> colHeaders) {
...
void VaporTable::addCheckbox(int row, int column, bool checked) {
    ...
    connect(checkBox, SIGNAL(stateChanged(int)), this, SLOT(emitMySignal()));
}
...
QLineEdit *VaporTable::createLineEdit(QString val) {
    ...
    connect(edit, SIGNAL(editingFinished()), this, SLOT(emitMySignal()));
