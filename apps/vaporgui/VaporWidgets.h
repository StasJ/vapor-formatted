...
class VSpinBox : public VLine {
  ...
  public:
    VSpinBox(QWidget *parent, const std::string &labelText = "Label", int min = 0, int max = 100,
             int defaultValue = 0);
...
class VRange : public VaporWidget {
  ...
  public:
    VRange(QWidget *parent, double min, double max, const std::string &minLabel = "Min",
...
class VGeometry : public VaporWidget {
  ...
  public:
    ...
    VGeometry(QWidget *parent, const std::vector<double> &extents,
