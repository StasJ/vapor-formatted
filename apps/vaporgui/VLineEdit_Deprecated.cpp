...
VLineEdit_Deprecated::VLineEdit_Deprecated(const std::string &value)
    ...
    connect(_lineEdit, &QLineEdit::editingFinished, this,
            &VLineEdit_Deprecated::emitLineEditChanged);
}
...
void VLineEdit_Deprecated::UseDoubleMenu() {
    ...
    connect(_lineEdit, &QLineEdit::customContextMenuRequested, this,
            &VLineEdit_Deprecated::ShowContextMenu);
}
...
void VLineEdit_Deprecated::ShowContextMenu(const QPoint &pos) {
    ...
    connect(decimalAction, &SpinBoxAction::editingFinished, this,
            &VLineEdit_Deprecated::_decimalDigitsChanged);
    menu.addAction(decimalAction);

    CheckBoxAction *checkBoxAction = new CheckBoxAction(tr("Scientific"), _scientific);
    connect(checkBoxAction, &CheckBoxAction::clicked, this,
            &VLineEdit_Deprecated::_scientificClicked);
