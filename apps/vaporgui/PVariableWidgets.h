...
class PScalarVariableSelectorHLI : public PScalarVariableSelector,
...
class PColorMapVariableSelectorHLI : public PColorMapVariableSelector,
  ...
  public:
    PColorMapVariableSelectorHLI()
        : PColorMapVariableSelector(), PWidgetHLIBase<VAPoR::RenderParams, std::string>(
                                           (PWidget *)this,
                                           &VAPoR::RenderParams::GetColorMapVariableName,
                                           &VAPoR::RenderParams::SetColorMapVariableName) {}
};

class PHeightVariableSelectorHLI : public PHeightVariableSelector,
                                   public PWidgetHLIBase<VAPoR::RenderParams, std::string> {
  public:
    PHeightVariableSelectorHLI()
        : PHeightVariableSelector(), PWidgetHLIBase<VAPoR::RenderParams, std::string>(
                                         (PWidget *)this,
                                         &VAPoR::RenderParams::GetHeightVariableName,
                                         &VAPoR::RenderParams::SetHeightVariableName) {}
};

class PXFieldVariableSelectorHLI : public PXFieldVariableSelector,
                                   public PWidgetHLIBase<VAPoR::RenderParams, std::string> {
  public:
    PXFieldVariableSelectorHLI()
        : PXFieldVariableSelector(), PWidgetHLIBase<VAPoR::RenderParams, std::string>(
                                         (PWidget *)this,
                                         &VAPoR::RenderParams::GetXFieldVariableName,
                                         &VAPoR::RenderParams::SetXFieldVariableName) {}
};

class PYFieldVariableSelectorHLI : public PYFieldVariableSelector,
                                   public PWidgetHLIBase<VAPoR::RenderParams, std::string> {
  public:
    PYFieldVariableSelectorHLI()
        : PYFieldVariableSelector(), PWidgetHLIBase<VAPoR::RenderParams, std::string>(
                                         (PWidget *)this,
                                         &VAPoR::RenderParams::GetYFieldVariableName,
                                         &VAPoR::RenderParams::SetYFieldVariableName) {}
};

class PZFieldVariableSelectorHLI : public PZFieldVariableSelector,
                                   public PWidgetHLIBase<VAPoR::RenderParams, std::string> {
  public:
    PZFieldVariableSelectorHLI()
        : PZFieldVariableSelector(), PWidgetHLIBase<VAPoR::RenderParams, std::string>(
                                         (PWidget *)this,
