...
void StartupEventRouter::chooseTFPath() {
    ...
    string dir =
        choosePathHelper(sParams->GetTFDir(), "Choose the Transfer Function file directory");
...
void StartupEventRouter::choosePythonPath() {
    ...
    string dir =
        choosePathHelper(sParams->GetPythonDir(), "Choose the Python script file directory");
