...
void MyBaseErrorCallback(const char *msg, int err_code) {
    ErrorReporter::getInstance()->log.push_back(
        ErrorReporter::Message(ErrorReporter::Error, string(msg), err_code));
    ErrorReporter::getInstance()->fullLog.push_back(
        ErrorReporter::Message(ErrorReporter::Error, string(msg), err_code));
...
void MyBaseDiagCallback(const char *msg) {
    ErrorReporter::getInstance()->log.push_back(
        ErrorReporter::Message(ErrorReporter::Diagnostic, string(msg)));
    ErrorReporter::getInstance()->fullLog.push_back(
        ErrorReporter::Message(ErrorReporter::Diagnostic, string(msg)));
#ifdef LOG_FILE
