...
PVariablesWidget::PVariablesWidget()
    ...
    connect(_scalarCombo, &VLineComboBox::ValueChanged, this, &PVariablesWidget::_scalarVarChanged);
    _vSection->layout()->addWidget(_scalarCombo);

    _xFieldCombo = new VLineComboBox("  X");
    connect(_xFieldCombo, &VLineComboBox::ValueChanged, this, &PVariablesWidget::_xFieldVarChanged);
    _vSection->layout()->addWidget(_xFieldCombo);

    _yFieldCombo = new VLineComboBox("  Y");
    connect(_yFieldCombo, &VLineComboBox::ValueChanged, this, &PVariablesWidget::_yFieldVarChanged);
    _vSection->layout()->addWidget(_yFieldCombo);

    _zFieldCombo = new VLineComboBox("  Z");
    connect(_zFieldCombo, &VLineComboBox::ValueChanged, this, &PVariablesWidget::_zFieldVarChanged);
    _vSection->layout()->addWidget(_zFieldCombo);

    _colorCombo = new VLineComboBox("Color mapped variable");
    connect(_colorCombo, &VLineComboBox::ValueChanged, this, &PVariablesWidget::_colorVarChanged);
    _vSection->layout()->addWidget(_colorCombo);

    _heightCombo = new VLineComboBox("Height variable");
    connect(_heightCombo, &VLineComboBox::ValueChanged, this, &PVariablesWidget::_heightVarChanged);
