...
//
// MAKE_COMPILER_ERROR:
//   /Users/pearse/VAPOR/apps/vaporgui/PVariablesWidget.cpp:34:25: error: no matching constructor
//   for
//         initialization of 'PVariableSelector3DHLI<VAPoR::RenderParams>'
//       _pscalarHLI3D = new PVariableSelector3DHLI<VAPoR::RenderParams>(
//                           ^
//   /Users/pearse/VAPOR/apps/vaporgui/PVariableSelectorHLI.h:61:5: note: candidate constructor not
//   viable: no
...
//    /Users/pearse/VAPOR/apps/vaporgui/VFidelitySection_PW.cpp:82:26: error: cannot initialize a
//    parameter of
//          type 'QWidget *' with an rvalue of type 'int'
//        layout()->addWidget( (int)1 );
//                             ^~~~~~
//    /usr/local/VAPOR-Deps/2019-Aug/Qt/5.13.2/clang_64/lib/QtWidgets.framework/Headers/qboxlayout.h:74:29:
//    note:
//          passing argument to parameter here
//        void addWidget(QWidget *, int stretch = 0, Qt::Alignment alignment = Qt::Alignment());
//                                  ^
//    /Users/pearse/VAPOR/apps/vaporgui/PVariablesWidget.cpp:61:21: error: no matching constructor
//    for
...
//          VSection' for 1st argument
//    class VSection : public QTabWidget {
//          ^
//    /Users/pearse/VAPOR/apps/vaporgui/VSection.h:22:5: note: candidate constructor not viable: no
//    known
//          conversion from 'int' to 'const std::string' (aka 'const basic_string<char,
...
PVariablesWidget::PVariablesWidget()
    ...
    connect(_dimCombo, &VLineComboBox::ValueChanged, this, &PVariablesWidget::_dimChanged);

    _pscalarHLI3D = new PVariableSelector3DHLI<VAPoR::RenderParams>(
        "Variable name",
#ifdef MAKE_COMPILER_ERROR
        &VAPoR::RenderParams::SetVariableName, &VAPoR::RenderParams::GetVariableName
#else
    ...
    _pheightHLI2D = new PVariableSelector2DHLI<VAPoR::RenderParams>(
        "Color variable", &VAPoR::RenderParams::GetHeightVariableName,
    ...
    _pcolorHLI3D = new PVariableSelector3DHLI<VAPoR::RenderParams>(
        "Color variable", &VAPoR::RenderParams::GetColorMapVariableName,
...
void PVariablesWidget::Reinit(VariableFlags variableFlags, DimFlags dimFlags) {
