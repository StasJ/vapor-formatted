...
void TFWidget::connectWidgets() {
    ...
    connect(_autoUpdateHistoCheckbox, SIGNAL(stateChanged(int)), this,
            SLOT(autoUpdateHistoChecked(int)));
    ...
    //
    connect(_colorMapOpacitySlider, SIGNAL(valueChanged(int)), this,
            SLOT(opacitySliderChanged(int)));
    connect(_colorMapUpdateHistoButton, SIGNAL(pressed()), this, SLOT(updateHisto()));
    connect(_colorMapAutoUpdateHistoCheckbox, SIGNAL(stateChanged(int)), this,
            SLOT(autoUpdateHistoChecked(int)));
    connect(_colorMapColorInterpCombo, SIGNAL(activated(int)), this, SLOT(colorInterpChanged(int)));
    connect(_colorMapWhitespaceCheckbox, SIGNAL(stateChanged(int)), this,
            SLOT(setUseWhitespace(int)));
    connect(_colorMapMinSliderEdit, SIGNAL(valueChanged(double)), this,
            SLOT(setColorMapMinRange(double)));
    connect(_colorMapMaxSliderEdit, SIGNAL(valueChanged(double)), this,
            SLOT(setColorMapMaxRange(double)));
}
