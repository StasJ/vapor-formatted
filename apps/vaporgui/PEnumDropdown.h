...
//! \class PEnumDropdown
//! Creates a Qt dropdown for selecting enum values synced with the paramsdatabase using the PWidget
//! interface. \copydoc PWidget
...
class PEnumDropdown : public PLineItem {
  ...
  protected slots:
    virtual void dropdownIndexChanged(int index);
};
