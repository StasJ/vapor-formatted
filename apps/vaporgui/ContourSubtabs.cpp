...
void ContourAppearanceSubtab::SetContourValues(int contourCount, double contourMin,
                                               double spacing) {
    vector<double> cVals;
    ...
    if (maxBound < cVals[contourCount - 1]) {
        contourCountEdit->setStyleSheet("background-color: red; "
                                        "color: white;");
        contourCountEdit->setToolTip("If the Contour Count display is red, one or\n"
