...
void ContourAppearanceSubtab::Update(VAPoR::DataMgr *dataMgr, VAPoR::ParamsMgr *paramsMgr,
    ...
    _lineWidthCombo->Update(lineWidthRange[0], lineWidthRange[1], _lineWidth);
...
void ContourAppearanceSubtab::Initialize(VAPoR::ContourParams *cParams) {
    ...
    double spacing = (_contourMax - _contourMin) / (double)(_numContours - 1);
