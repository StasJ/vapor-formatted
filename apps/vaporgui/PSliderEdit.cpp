...
PDoubleSliderEdit::PDoubleSliderEdit(const std::string &tag, const std::string &label)
    ...
    connect(_sliderEdit, &VSliderEdit::ValueChangedIntermediate, this,
...
PIntegerSliderEdit::PIntegerSliderEdit(const std::string &tag, const std::string &label)
    ...
    connect(_sliderEdit, &VSliderEdit::ValueChangedIntIntermediate, this,
            &PIntegerSliderEdit::valueChangedIntermediate);
}
