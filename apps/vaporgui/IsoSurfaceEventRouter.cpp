...
//
// static RenderEventRouterRegistrar<IsoSurfaceEventRouter>
// registrar(IsoSurfaceEventRouter::GetClassType() );

IsoSurfaceEventRouter::IsoSurfaceEventRouter(QWidget *parent, ControlExec *ce)
    : QTabWidget(parent), RenderEventRouter(ce, IsoSurfaceParams::GetClassType()) {
