...
//! \class PFileSelector
//! Creates a Qt text box and select button that allows users to pick a file path synced with the
//! paramsdatabase using the PWidget interface. \copydoc PWidget
