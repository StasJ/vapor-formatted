...
AnimationEventRouter::AnimationEventRouter(QWidget *parent, ControlExec *ce)
    : QWidget(parent), Ui_AnimationTab(), EventRouter(ce, AnimationParams::GetClassType()) {
    setupUi(this);
...
void AnimationEventRouter::_updateTab() {
    ...
    if (!_widgetsEnabled && !_animationOn) {
        enableWidgets(true);
    }
