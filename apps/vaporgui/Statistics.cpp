...
Statistics::Statistics(QWidget *parent) : QDialog(parent), Ui_StatsWindow() {
    ...
    MyGeometryWidget->Reinit(GeometryWidget::THREED, GeometryWidget::MINMAX,
...
bool Statistics::Connect() {
    ...
    // connect( RefCombo,          SIGNAL(currentIndexChanged(int)), this,
    // SLOT(_refinementChanged(int)) ); connect( LODCombo,          SIGNAL(currentIndexChanged(int)),
    // this, SLOT(_lodChanged(int)) );
