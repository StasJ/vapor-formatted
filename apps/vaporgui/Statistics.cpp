...
int Statistics::initialize() {
    ...
    // SLOT(rangeComboChanged())); connect(copyActiveRegionButton, SIGNAL(pressed()), this,
    // SLOT(copyActiveRegion()));
...
void Statistics::exportText() {
    ...
    QString fName =
        QFileDialog::getSaveFileName(this, "Select file to write statistics into:", "", "*.txt");
    if (!fName.isEmpty()) {
        ofstream file;
