...
OptionParser::OptDescRec_T set_opts[] = {
    ...
    {"output", 1, "vapor.tiff",
     "Output image file when using -render. This will be suffixed with the timestep number. "
     "Supports tiff, jpg"},
    {NULL}};
...
// For Mac and Linux, set the PYTHONHOME in this app
    ...
    int estatus = 0;
    if (opt.render) {
        estatus = mw->RenderAndExit(opt.renderRange.min, opt.renderRange.max, opt.outputPath,
