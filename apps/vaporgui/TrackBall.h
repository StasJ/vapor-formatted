...
class Trackball {
  public:
    ...
    void MouseOnTrackball(int eventType, int thisButton, int xcrd, int ycrd, unsigned width,
                          unsigned height);
    ...
    //
    void setFromFrame(const std::vector<double> &posvec, const std::vector<double> &dirvec,
                      const std::vector<double> &upvec, const std::vector<double> &centerRot,
                      bool perspective);

    void setFromFrame(const double posvec[3], const double dirvec[3], const double upvec[3],
