...
class MappingFrame : public QGLWidget {
  ...
  private:
    ...
    void populateVolumetricHistogram(VAPoR::Grid *grid, std::vector<double> minExt,
                                     std::vector<double> maxExt);
    void populateSlicingHistogram(VAPoR::Grid *grid, std::vector<double> minExt,
                                  std::vector<double> maxExt);
    void _getSampleCoordinates(std::vector<double> &coords, std::vector<double> minExts,
