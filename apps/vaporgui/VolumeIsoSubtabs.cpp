...
VolumeIsoAppearanceSubtab::VolumeIsoAppearanceSubtab(QWidget *parent) {
    ...
    _osprayGroup->Add(
        (new ParamsWidgetNumber(OSPRayParams::_samplesPerPixelTag, "Samples Per Pixel"))
            ->SetRange(1, 100));
    _osprayGroup->Add(
        (new ParamsWidgetNumber(OSPRayParams::_aoSamplesTag, "Ambient Occlusion Samples"))
            ->SetRange(0, 1000));
    _osprayGroup->Add(
        (new ParamsWidgetFloat(OSPRayParams::_ambientIntensity, "Ambient Light"))->SetRange(0, 1));
    _osprayGroup->Add(
        (new ParamsWidgetFloat(OSPRayParams::_spotlightIntensity, "Spotlight"))->SetRange(0, 1));
