...
IsoSurfaceAppearanceSubtab::IsoSurfaceAppearanceSubtab(QWidget *parent) {
    setupUi(this);
    _TFWidget->Reinit((TFFlags)(CONSTANT_COLOR | COLORVAR_IS_IN_TF2));
...
void IsoSurfaceAppearanceSubtab::Update(VAPoR::DataMgr *dataMgr, VAPoR::ParamsMgr *paramsMgr,
    ...
    VAPoR::Grid *grid = dataMgr->GetVariable(
