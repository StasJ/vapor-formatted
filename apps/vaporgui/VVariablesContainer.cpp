...
VVariablesContainer::VVariablesContainer() : VContainer(new QVBoxLayout) {
...
void VVariablesContainer::Reinit(VariableFlags varFlags, DimFlags dimFlags) {
    _variablesSection->Reinit(varFlags, dimFlags);
    _fidelitySection->Reinit(varFlags);
}

void VVariablesContainer::Update(VAPoR::RenderParams *rParams, VAPoR::ParamsMgr *paramsMgr,
