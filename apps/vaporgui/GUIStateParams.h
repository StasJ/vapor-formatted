...
class GUIStateParams : public VAPoR::ParamsBase {
    ...
    class DataSetParam : public ParamsBase {
      public:
        DataSetParam(VAPoR::ParamsBase::StateSave *ssave)
            : ParamsBase(ssave, DataSetParam::GetClassType()) {}
        ...
        void SetPaths(const std::vector<string> &paths) {
            SetValueStringVec(m_dataSetPathsTag, "Data set paths", paths);
        }

        std::vector<string> GetPaths() const { return (GetValueStringVec(m_dataSetPathsTag)); };

        void SetFormat(string format) {
            SetValueString(m_dataSetFormatTag, "Data set format", format);
        }
  ...
  private:
    class ActiveRenderer : public ParamsBase {
      public:
        ActiveRenderer(VAPoR::ParamsBase::StateSave *ssave)
            : ParamsBase(ssave, ActiveRenderer::GetClassType()) {}

        ActiveRenderer(VAPoR::ParamsBase::StateSave *ssave, VAPoR::XmlNode *node)
            : ParamsBase(ssave, node) {}
