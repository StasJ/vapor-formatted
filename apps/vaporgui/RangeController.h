...
class Controller : public QObject {
  ...
  public:
    ...
    Controller(Range *range, int type = 0);
    ~Controller(){};
...
class MinMaxSlider : public Controller, public Observer {
  ...
  public:
    ...
    //
    MinMaxSlider(Range *range, QSlider *slider, int type = 0);
    ~MinMaxSlider(){};
    void notify();
...
class TimeSlider : public MinMaxSlider {
  ...
  public:
    ...
    //
    TimeSlider(Range *range, QSlider *slider, int type = 0);
    ~TimeSlider(){};
    void setConst(bool c);
};
...
class RangeLabel : public QObject, public Observer {
  ...
  public:
    //! \copydoc MinMaxSlider::MinMaxSlider()
    //
    RangeLabel(Range *range, QLabel *label, int type = 0);
    ~RangeLabel(){};
...
class MinMaxLabel : public RangeLabel {
  ...
  public:
    MinMaxLabel(Range *range, QLabel *label, int type = 0);
    ~MinMaxLabel(){};
    void notify();
...
class SizeLabel : public RangeLabel {
  ...
  public:
    SizeLabel(Range *range, QLabel *label, int type = 0);
    ~SizeLabel(){};
    void notify();
...
class MinMaxLineEdit : public Controller, public Observer {
  ...
  public:
    //! \copydoc MinMaxSlider::MinMaxSlider()
    //
    MinMaxLineEdit(Range *range, QLineEdit *lineEdit, int type);
    ~MinMaxLineEdit(){};
    void notify();
...
class SinglePointSlider : public Controller, public Observer {
  ...
  public:
    ...
    //
    SinglePointSlider(Range *range, QSlider *slider, int defaultPos = 2);
    ~SinglePointSlider(){};
    void notify();
...
class SinglePointLineEdit : public Controller, public Observer {
  ...
  public:
    ...
    //
    SinglePointLineEdit(Range *range, QLineEdit *lineEdit, double defaultVal);
    ~SinglePointLineEdit(){};
    void notify();
...
class CenterSizeSlider : public Controller, public Observer {
  ...
  public:
    ...
    //
    CenterSizeSlider(Range *range, QSlider *slider, int type);
    ~CenterSizeSlider(){};
    void notify();
...
class CenterSizeLineEdit : public Controller, public Observer {
  ...
  public:
    ...
    //! type 1 = size value controller
    //
    CenterSizeLineEdit(Range *range, QLineEdit *lineEdit, int type);
    ~CenterSizeLineEdit(){};
    void notify();
...
class MinMaxTableCell : public Controller, public Observer {
  ...
  public:
    ...
    //
    MinMaxTableCell(Range *range, QTableWidget *table, int type, int row, int col);
    ~MinMaxTableCell(){};
    void notify();
