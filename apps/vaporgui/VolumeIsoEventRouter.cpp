...
//
static RenderEventRouterRegistrar<VolumeIsoEventRouter>
    registrar(VolumeIsoEventRouter::GetClassType());

VolumeIsoEventRouter::VolumeIsoEventRouter(QWidget *parent, ControlExec *ce)
    : QTabWidget(parent), RenderEventRouter(ce, VolumeIsoParams::GetClassType()) {
...
string VolumeIsoEventRouter::_getDescription() const { return ("New IsoSurface Renderer"); }
