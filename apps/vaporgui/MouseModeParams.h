...
class MouseModeParams : public VAPoR::ParamsBase {
  ...
  public:
    ...
    void SetCameraPos(const double position[3]) {
        _set3(_positionVectorTag, "Set camera position", position);
    }
    ...
    void SetCameraViewDir(const double viewDir[3]) {
        _set3(_directionVectorTag, "Set camera view direction", viewDir);
    }
    ...
    void SetCameraUpVec(const double upVec[3]) {
        _set3(_upVectorTag, "Set camera up vector", upVec);
    }
    ...
    void SetRotationCenter(const double center[3]) {
        _set3(_rotCenterTag, "Set rotation center", center);
    }
    ...
    void SetCameraPosHome(const double position[3]) {
        _set3(_positionVectorHomeTag, "Set camera position home", position);
    }
    ...
    void SetCameraViewDirHome(const double viewDir[3]) {
        _set3(_directionVectorHomeTag, "Set camera view direction home", viewDir);
    }
    ...
    void SetCameraUpVecHome(const double upVec[3]) {
        _set3(_upVectorHomeTag, "Set camera up vector home", upVec);
    }
    ...
    //! \param[in] vector<double>& rotation center in local coordinates
    //! \retval int 0 if successful
    void SetRotationCenterHome(const double center[3]) {
        _set3(_rotCenterHomeTag, "Set rotation center home", center);
    }
