...
void StartupParams::SetSessionDir(string name) {
...
void StartupParams::SetMetadataDir(string dir) {
...
void StartupParams::SetImageDir(string dir) {
...
void StartupParams::SetDefaultImageDir(string dir) {
...
void StartupParams::SetTFDir(string dir) {
...
void StartupParams::SetFlowDir(string dir) {
...
void StartupParams::SetDefaultFlowDir(string dir) {
    SetValueString(_defaultFlowDirTag, "set default flow save directory", dir);
}
...
void StartupParams::SetPythonDir(string dir) {
...
void StartupParams::SetDefaultPythonDir(string dir) {
    SetValueString(_defaultPythonDirTag, "set default python directory", dir);
}
...
void StartupParams::SetCurrentPrefsPath(string pth) {
