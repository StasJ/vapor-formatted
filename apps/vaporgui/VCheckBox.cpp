...
VCheckBox2::VCheckBox2(bool checked) : VContainer(this) {
...
bool VCheckBox2::GetValue() const { return _checkBox->isChecked(); }

void VCheckBox2::emitCheckBoxChanged(bool checked) { emit ValueChanged(checked); }
