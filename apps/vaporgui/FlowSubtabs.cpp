...
FlowVariablesSubtab::FlowVariablesSubtab(QWidget *parent) : QVaporSubtab(parent) {
    ...
    connect(_variablesWidget, &VariablesWidget::_dimensionalityChanged, this,
            &FlowVariablesSubtab::_dimensionalityChanged);
...
void FlowVariablesSubtab::Update(VAPoR::DataMgr *dataMgr, VAPoR::ParamsMgr *paramsMgr,
    ...
    //    GUIStateParams *gp =
    //    dynamic_cast<GUIStateParams*>(_paramsMgr->GetParams(GUIStateParams::GetClassType())); int
    //    nDims = gp->GetFlowDimensionality(); bool no3DVars = dataMgr->GetDataVarNames(3).size() ?
    //    false : true;
...
FlowSeedingSubtab::FlowSeedingSubtab(QWidget *parent)
    ...
    _geometryWriterSection->layout()->addWidget(
        new VLineItem("Target file", _geometryWriterSelector));
    ...
    connect(_geometryWriterExecutor, &VPushButton::ButtonClicked, this,
            &FlowSeedingSubtab::_geometryWriterClicked);
    layout()->addWidget(_geometryWriterSection);
}
...
void FlowSeedingSubtab::_createSeedingSection(QWidget *parent) {
    ...
    connect(_xSeedSliderEdit, &VSliderEdit::ValueChangedInt, this,
    ...
    connect(_ySeedSliderEdit, &VSliderEdit::ValueChangedInt, this,
            &FlowSeedingSubtab::_rakeNumOfSeedsChanged);
    ...
    connect(_zSeedSliderEdit, &VSliderEdit::ValueChangedInt, this,
            &FlowSeedingSubtab::_rakeNumOfSeedsChanged);

    // List of seeds selection
    _listOfSeedsFileReader = new VFileReader();
    connect(_listOfSeedsFileReader, &VFileReader::ValueChanged, this,
            &FlowSeedingSubtab::_seedListFileChanged);
...
Any line that is empty or starts with a # is not considered as input.");
    ...
    connect(_randomSeedsSliderEdit, &VSliderEdit::ValueChangedInt, this,
            &FlowSeedingSubtab::_randomNumOfSeedsChanged);
    ...
    connect(_biasWeightSliderEdit, &VSliderEdit::ValueChanged, this,
            &FlowSeedingSubtab::_biasStrengthChanged);

    _biasVariableComboBox = new VComboBox(std::vector<std::string>());
    _randomSeedsFrame->addWidget(
        new VLineItem("Bias variable", _biasVariableComboBox)); // 3rd widget
    connect(_biasVariableComboBox, &VComboBox::ValueChanged, this,
            &FlowSeedingSubtab::_biasVariableChanged);
...
void FlowSeedingSubtab::_createIntegrationSection() {
    ...
    connect(_streamlineDirectionCombo, &VComboBox::IndexChanged, this,
            &FlowSeedingSubtab::_streamlineDirectionChanged);
    ...
    connect(_streamlineSamplesSliderEdit, &VSliderEdit::ValueChangedInt, this,
            &FlowSeedingSubtab::_streamlineSamplesChanged);
    ...
    connect(_pathlineLengthSliderEdit, &VSliderEdit::ValueChangedInt, this,
            &FlowSeedingSubtab::_pathlineLengthChanged);
    ...
    connect(_pathlineInjInterval, &VSliderEdit::ValueChangedInt, this,
            &FlowSeedingSubtab::_seedInjIntervalChanged);
    ...
    connect(_periodicZCheckBox, &VCheckBox::ValueChanged, this,
            &FlowSeedingSubtab::_periodicClicked);
...
void FlowSeedingSubtab::_streamlineSamplesChanged(int newval) {
