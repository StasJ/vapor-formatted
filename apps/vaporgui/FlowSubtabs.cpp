...
FlowSeedingSubtab::FlowSeedingSubtab(QWidget *parent) : QVaporSubtab(parent) {
    ...
    connect(_geometryWriterExecutor, SIGNAL(ButtonClicked()), this, SLOT(_geometryWriterClicked()));
    layout()->addWidget(_geometryWriterSection);
}
...
void FlowSeedingSubtab::_createIntegrationSection() {
    ...
    connect(_streamlineDirectionCombo, SIGNAL(ValueChanged(int)), this,
            SLOT(_streamlineDirectionChanged(int)));
    ...
    connect(_streamlineSamplesSliderEdit, SIGNAL(ValueChanged(int)), this,
            SLOT(_streamlineSamplesChanged(int)));
    ...
    connect(_pathlineStartSliderEdit, SIGNAL(ValueChanged(int)), this,
            SLOT(_pathlineStartTimeChanged(int)));
    ...
    connect(_pathlineEndSliderEdit, SIGNAL(ValueChanged(int)), this,
            SLOT(_pathlineEndTimeChanged(int)));
    ...
    connect(_pathlineInjIntervalSliderEdit, SIGNAL(ValueChanged(int)), this,
    ...
    connect(_pathlineLifetimeSliderEdit, SIGNAL(ValueChanged(int)), this,
            SLOT(_pathlineLifetimeChanged(int)));
