...
RenderEventRouter *TabManager::_getRenderEventRouter(string winName, string renderType,
...
void TabManager::_createAllDefaultTabs() {
    ...
    connect((NavigationEventRouter *)er, SIGNAL(ProjectionTypeChanged(int)), this,
            SLOT(_projectionTypeChanged(int)));
...
void TabManager::_initRenderHolder() {
    ...
    _renderHolder = new RenderHolder(this, _controlExec, widgets, widgetNames, descriptions,
                                     iconPaths, smallIconPaths, dim2dSupport, dim3dSupport);
