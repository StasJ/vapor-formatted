...
VSpinBox2::VSpinBox2(int min, int max) : VContainer(this) {
...
void VSpinBox2::SetRange(int min, int max) { _spinBox->setRange(min, max); }

int VSpinBox2::GetValue() const { return _spinBox->value(); }
