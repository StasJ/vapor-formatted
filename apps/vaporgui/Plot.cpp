...
void Plot::Update() {
    ...
    PlotParams *plotParams =
        dynamic_cast<PlotParams *>(_controlExec->GetParamsMgr()->GetAppRenderParams(
            currentDatasetName, PlotParams::GetClassType()));
...
void Plot::_newVarChanged(int index) {
    ...
    PlotParams *plotParams = dynamic_cast<PlotParams *>(
        _controlExec->GetParamsMgr()->GetAppRenderParams(dsName, PlotParams::GetClassType()));
