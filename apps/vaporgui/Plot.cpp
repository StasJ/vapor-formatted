...
void Plot::_updateExtents() {
    ...
    if (TSToExamine[1] != TSToExamine[0]) {
        VAPoR::DataMgrUtils::GetExtents(currentDmgr, TSToExamine[1], enabledVars, minT1, maxT1,
                                        axes);
    } else {
        minT1 = min;
        maxT1 = max;
    ...
    if ((TSToExamine[2] != TSToExamine[1]) && (TSToExamine[2] != TSToExamine[0])) {
        VAPoR::DataMgrUtils::GetExtents(currentDmgr, TSToExamine[2], enabledVars, minT2, maxT2,
                                        axes);
    } else {
        minT2 = min;
        maxT2 = max;
