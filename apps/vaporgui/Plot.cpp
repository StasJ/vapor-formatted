...
void Plot::_updateExtents() {
    ...
    std::vector<int> axes;
    VAPoR::DataMgrUtils::GetExtents(currentDmgr, plotParams->GetCurrentTimestep(), enabledVars, min,
                                    max, axes);
    VAPoR::DataMgrUtils::GetExtents(currentDmgr, plotParams->GetMinMaxTS().at(0), enabledVars,
                                    minT1, maxT1, axes);
    VAPoR::DataMgrUtils::GetExtents(currentDmgr, plotParams->GetMinMaxTS().at(1), enabledVars,
                                    minT2, maxT2, axes);
