...
OptionParser::Option_T get_options[] = {
    ...
    {"long", Wasp::CvtToBoolean, &opt._long, sizeof(opt._long)},
    {"numeric", Wasp::CvtToBoolean, &opt.numeric, sizeof(opt.numeric)},
    {NULL}};
...
int main(int argc, char **argv) {
    ...
    if (opt._long) {
        ...
        cout << "Vapor " << Version::GetBuildType() << " version "
             << Version::GetFullVersionString() << " (" << Version::GetDateString() << ")" << endl;
    } else if (opt.numeric) {
