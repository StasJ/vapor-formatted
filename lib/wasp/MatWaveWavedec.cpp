...
template <class T>
int wavedec_template(MatWaveWavedec *mww, const T *sigIn, size_t sigInLength, int n, T *C,
                     size_t *L) {
    if (!mww->wavelet()) {
    ...
    if (n == 0) {
        for (size_t i = 0; i < sigInLength; i++)
            C[i] = sigIn[i];
        return (0);
    }
...
int MatWaveWavedec::wavedec(const double *sigIn, size_t sigInLength, int n, double *C, size_t *L) {
    return wavedec_template(this, sigIn, sigInLength, n, C, L);
}

int MatWaveWavedec::wavedec(const float *sigIn, size_t sigInLength, int n, float *C, size_t *L) {
    return wavedec_template(this, sigIn, sigInLength, n, C, L);
}

int MatWaveWavedec::wavedec(const long *sigIn, size_t sigInLength, int n, long *C, size_t *L) {
    return wavedec_template(this, sigIn, sigInLength, n, C, L);
}

int MatWaveWavedec::wavedec(const int *sigIn, size_t sigInLength, int n, int *C, size_t *L) {
    return wavedec_template(this, sigIn, sigInLength, n, C, L);
}

template <class T>
int waverec_template(MatWaveWavedec *mww, const T *C, const size_t *L, int n, int l, bool normal,
                     T *sigOut) {
    if (!mww->wavelet()) {
        MatWaveWavedec::SetErrMsg("Invalid state, no wavelet");
        return (-1);
...
int MatWaveWavedec::waverec(const double *C, const size_t *L, int n, double *sigOut) {
    return waverec_template(this, C, L, n, n, false, sigOut);
}

int MatWaveWavedec::waverec(const float *C, const size_t *L, int n, float *sigOut) {
    return waverec_template(this, C, L, n, n, false, sigOut);
}

int MatWaveWavedec::waverec(const long *C, const size_t *L, int n, long *sigOut) {
    return waverec_template(this, C, L, n, n, false, sigOut);
}

int MatWaveWavedec::waverec(const int *C, const size_t *L, int n, int *sigOut) {
    return waverec_template(this, C, L, n, n, false, sigOut);
}

int MatWaveWavedec::appcoef(const double *C, const size_t *L, int n, int l, bool normal,
                            double *sigOut) {
    return waverec_template(this, C, L, n, l, normal, sigOut);
}

int MatWaveWavedec::appcoef(const float *C, const size_t *L, int n, int l, bool normal,
                            float *sigOut) {
    return waverec_template(this, C, L, n, l, normal, sigOut);
}

int MatWaveWavedec::appcoef(const long *C, const size_t *L, int n, int l, bool normal,
                            long *sigOut) {
    return waverec_template(this, C, L, n, l, normal, sigOut);
}

int MatWaveWavedec::appcoef(const int *C, const size_t *L, int n, int l, bool normal, int *sigOut) {
    return waverec_template(this, C, L, n, l, normal, sigOut);
}

template <class T>
int wavedec2_template(MatWaveWavedec *mww, const T *sigIn, size_t sigInX, size_t sigInY, int n,
                      T *C, size_t *L) {
...
int MatWaveWavedec::wavedec2(const double *sigIn, size_t sigInX, size_t sigInY, int n, double *C,
                             size_t *L) {
    return wavedec2_template(this, sigIn, sigInX, sigInY, n, C, L);
}

int MatWaveWavedec::wavedec2(const float *sigIn, size_t sigInX, size_t sigInY, int n, float *C,
                             size_t *L) {
    return wavedec2_template(this, sigIn, sigInX, sigInY, n, C, L);
}

int MatWaveWavedec::wavedec2(const long *sigIn, size_t sigInX, size_t sigInY, int n, long *C,
                             size_t *L) {
    return wavedec2_template(this, sigIn, sigInX, sigInY, n, C, L);
}

int MatWaveWavedec::wavedec2(const int *sigIn, size_t sigInX, size_t sigInY, int n, int *C,
                             size_t *L) {
    return wavedec2_template(this, sigIn, sigInX, sigInY, n, C, L);
}

template <class T>
int waverec2_template(MatWaveWavedec *mww, const T *C, const size_t *L, int n, int l, bool normal,
                      T *sigOut) {
    if (!mww->wavelet()) {
        MatWaveWavedec::SetErrMsg("Invalid state, no wavelet");
        return (-1);
    ...
    for (int i = 1; i <= l; i++) {
        ...
        cA = sigOut;
        cDh += L[6 * (i - 1) + 2] * L[6 * (i - 1) + 3] + L[6 * (i - 1) + 4] * L[6 * (i - 1) + 5] +
               L[6 * (i - 1) + 6] * L[6 * (i - 1) + 7];
    ...
    if (l != n && normal) {
        ...
        for (int i = l; i < n; i++)
            scale /= (sqrt(2.0) * sqrt(2.0));
        for (size_t i = 0; i < L2d[8] * L2d[9]; i++)
            sigOut[i] *= scale;
    }
...
int MatWaveWavedec::waverec2(const double *C, const size_t *L, int n, double *sigOut) {
    return waverec2_template(this, C, L, n, n, false, sigOut);
}

int MatWaveWavedec::waverec2(const float *C, const size_t *L, int n, float *sigOut) {
    return waverec2_template(this, C, L, n, n, false, sigOut);
}

int MatWaveWavedec::waverec2(const long *C, const size_t *L, int n, long *sigOut) {
    return waverec2_template(this, C, L, n, n, false, sigOut);
}

int MatWaveWavedec::waverec2(const int *C, const size_t *L, int n, int *sigOut) {
    return waverec2_template(this, C, L, n, n, false, sigOut);
}

int MatWaveWavedec::appcoef2(const double *C, const size_t *L, int n, int l, bool normal,
                             double *sigOut) {
    return waverec2_template(this, C, L, n, l, normal, sigOut);
}

int MatWaveWavedec::appcoef2(const float *C, const size_t *L, int n, int l, bool normal,
                             float *sigOut) {
    return waverec2_template(this, C, L, n, l, normal, sigOut);
}

int MatWaveWavedec::appcoef2(const long *C, const size_t *L, int n, int l, bool normal,
                             long *sigOut) {
    return waverec2_template(this, C, L, n, l, normal, sigOut);
}

int MatWaveWavedec::appcoef2(const int *C, const size_t *L, int n, int l, bool normal,
                             int *sigOut) {
    return waverec2_template(this, C, L, n, l, normal, sigOut);
}

template <class T>
int wavedec3_template(MatWaveWavedec *mww, const T *sigIn, size_t sigInX, size_t sigInY,
                      size_t sigInZ, int n, T *C, size_t *L) {
...
int MatWaveWavedec::wavedec3(const double *sigIn, size_t sigInX, size_t sigInY, size_t sigInZ,
                             int n, double *C, size_t *L) {
    return wavedec3_template(this, sigIn, sigInX, sigInY, sigInZ, n, C, L);
}

int MatWaveWavedec::wavedec3(const float *sigIn, size_t sigInX, size_t sigInY, size_t sigInZ, int n,
                             float *C, size_t *L) {
    return wavedec3_template(this, sigIn, sigInX, sigInY, sigInZ, n, C, L);
}

int MatWaveWavedec::wavedec3(const long *sigIn, size_t sigInX, size_t sigInY, size_t sigInZ, int n,
                             long *C, size_t *L) {
    return wavedec3_template(this, sigIn, sigInX, sigInY, sigInZ, n, C, L);
}

int MatWaveWavedec::wavedec3(const int *sigIn, size_t sigInX, size_t sigInY, size_t sigInZ, int n,
                             int *C, size_t *L) {
    return wavedec3_template(this, sigIn, sigInX, sigInY, sigInZ, n, C, L);
}

template <class T>
int waverec3_template(MatWaveWavedec *mww, const T *C, const size_t *L, int n, int l, bool normal,
                      T *sigOut) {
    if (!mww->wavelet()) {
        MatWaveWavedec::SetErrMsg("Invalid state, no wavelet");
        return (-1);
    ...
    if (l == 0) {
        ...
        if (normal) {
            for (int i = l; i < n; i++)
                scale /= (sqrt(2.0) * sqrt(2.0) * sqrt(2.0));
        }
    ...
    size_t L3d[27] = {L[0],  L[1],  L[2],  L[3],  L[4],  L[5],  L[6],  L[7],  L[8],
                      L[9],  L[10], L[11], L[12], L[13], L[14], L[15], L[16], L[17],
                      L[18], L[19], L[20], L[21], L[22], L[23], 0,     0,     0};
    ...
    for (int i = 1; i <= l; i++) {
        ...
        cLLH += (L[21 * (i - 1) + 3] * L[21 * (i - 1) + 4] * L[21 * (i - 1) + 5]) +
    ...
    if (l != n && normal) {
        ...
        for (int i = l; i < n; i++)
            scale /= (sqrt(2.0) * sqrt(2.0) * sqrt(2.0));
        for (size_t i = 0; i < L3d[24] * L3d[25] * L3d[26]; i++)
            sigOut[i] *= scale;
    }
...
int MatWaveWavedec::waverec3(const double *C, const size_t *L, int n, double *sigOut) {
    return waverec3_template(this, C, L, n, n, false, sigOut);
}

int MatWaveWavedec::waverec3(const float *C, const size_t *L, int n, float *sigOut) {
    return waverec3_template(this, C, L, n, n, false, sigOut);
}

int MatWaveWavedec::waverec3(const long *C, const size_t *L, int n, long *sigOut) {
    return waverec3_template(this, C, L, n, n, false, sigOut);
}

int MatWaveWavedec::waverec3(const int *C, const size_t *L, int n, int *sigOut) {
    return waverec3_template(this, C, L, n, n, false, sigOut);
}

int MatWaveWavedec::appcoef3(const double *C, const size_t *L, int n, int l, bool normal,
                             double *sigOut) {
    return waverec3_template(this, C, L, n, l, normal, sigOut);
}

int MatWaveWavedec::appcoef3(const float *C, const size_t *L, int n, int l, bool normal,
                             float *sigOut) {
    return waverec3_template(this, C, L, n, l, normal, sigOut);
}

int MatWaveWavedec::appcoef3(const long *C, const size_t *L, int n, int l, bool normal,
                             long *sigOut) {
    return waverec3_template(this, C, L, n, l, normal, sigOut);
}

int MatWaveWavedec::appcoef3(const int *C, const size_t *L, int n, int l, bool normal,
                             int *sigOut) {
    return waverec3_template(this, C, L, n, l, normal, sigOut);
}
...
void MatWaveWavedec::computeL3(size_t sigInX, size_t sigInY, size_t sigInZ, int n,
                               size_t *L) const {
...
void MatWaveWavedec::approxlength2(const size_t *L, int n, int l, size_t *lenx,
                                   size_t *leny) const {
    if (l > n)
        l = n;
...
void MatWaveWavedec::approxlength3(const size_t *L, int n, int l, size_t *lenx, size_t *leny,
                                   size_t *lenz) const {
    if (l > n)
        l = n;
