...
void WaveFiltInt::Analysis(const long *sigIn, size_t sigInLen, long *cA, long *cD, bool oddlow,
                           bool oddhigh) const {
    if (_wavename == "intbior2.2" || _wavename == "intcdf5/3") {
...
void WaveFiltInt::_SynthesisCDF5_3(const long *cA, const long *cD, size_t sigInLen,
                                   long *sigOut) const {
