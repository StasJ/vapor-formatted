...
MatWaveBase::MatWaveBase(const string &wname) {
    ...
    string wmode;
    if ((_wname.compare("bior1.1") == 0) || (_wname.compare("bior1.3") == 0) ||
        (_wname.compare("bior1.5") == 0) || (_wname.compare("bior3.3") == 0) ||
        (_wname.compare("bior3.5") == 0) || (_wname.compare("bior3.7") == 0) ||
        (_wname.compare("bior3.9") == 0)) {

        wmode = "symh";
    } else if ((_wname.compare("bior2.2") == 0) || (_wname.compare("bior2.4") == 0) ||
               (_wname.compare("bior2.6") == 0) || (_wname.compare("bior2.8") == 0) ||
               (_wname.compare("bior4.4") == 0) || (_wname.compare("intbior2.2") == 0)) {
...
size_t MatWaveBase::detaillength(size_t sigInLen) const {
    ...
    if (_mode == PER) {
        ...
        if ((_mode == MatWaveBase::SYMW && (filterLen % 2)) ||
...
void MatWaveBase::_wave_len_validate(size_t sigInLen, int waveLength, size_t *lev,
                                     size_t *status) const {
    *lev = 0;
    *status = 1;
