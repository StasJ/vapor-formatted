...
#define MY_NC_ERR(rc, path, func)                                                                  \
    if (rc != NC_NOERR) {                                                                          \
        string msg = func;                                                                         \
        SetErrMsg("Error accessing netCDF file \"%s\", %s : %s -- file (%s), line(%d)",            \
...
int NetCDFCpp::CopyAtt(string varname_in, string attname, NetCDFCpp &ncdf_out,
                       string varname_out) const {
...
// PutAtt - Integer
//
int NetCDFCpp::PutAtt(string varname, string attname, int value) const {
...
// GetAtt - Integer
//
int NetCDFCpp::GetAtt(string varname, string attname, int &value) const {
...
// PutAtt - size_t
//
int NetCDFCpp::PutAtt(string varname, string attname, size_t value) const {
    return (NetCDFCpp::PutAtt(varname, attname, &value, 1));
}
...
// GetAtt - size_t
//
int NetCDFCpp::GetAtt(string varname, string attname, size_t &value) const {
    return (NetCDFCpp::GetAtt(varname, attname, &value, 1));
}
...
int NetCDFCpp::GetAtt(string varname, string attname, size_t values[], size_t n) const {
    ...
    vector<int> ivalues;
    int rc = NetCDFCpp::GetAtt(varname, attname, ivalues);
    for (int i = 0; i < ivalues.size() && i < n; i++)
        values[i] = ivalues[i];
...
// PutAtt - Float
//
int NetCDFCpp::PutAtt(string varname, string attname, float value) const {
    return (NetCDFCpp::PutAtt(varname, attname, &value, 1));
}
...
// PutAtt - Double
//
int NetCDFCpp::PutAtt(string varname, string attname, double value) const {
    return (NetCDFCpp::PutAtt(varname, attname, &value, 1));
}
...
// GetAtt - Float
//
int NetCDFCpp::GetAtt(string varname, string attname, float &value) const {
    return (NetCDFCpp::GetAtt(varname, attname, &value, 1));
}
...
// GetAtt - Double
//
int NetCDFCpp::GetAtt(string varname, string attname, double &value) const {
    return (NetCDFCpp::GetAtt(varname, attname, &value, 1));
}
...
int NetCDFCpp::_PutVara(string varname, vector<size_t> start, vector<size_t> count,
...
int NetCDFCpp::PutVara(string varname, vector<size_t> start, vector<size_t> count,
                       const void *data) {
    return (_PutVara(varname, start, count, (const void *)data, "nc_put_vara"));
}

int NetCDFCpp::PutVara(string varname, vector<size_t> start, vector<size_t> count,
                       const float *data) {
    return (_PutVara(varname, start, count, (const void *)data, "nc_put_vara_float"));
}

int NetCDFCpp::PutVara(string varname, vector<size_t> start, vector<size_t> count,
                       const double *data) {
    return (_PutVara(varname, start, count, (const void *)data, "nc_put_vara_double"));
}

int NetCDFCpp::PutVara(string varname, vector<size_t> start, vector<size_t> count,
                       const int *data) {
    return (_PutVara(varname, start, count, (const void *)data, "nc_put_vara_int"));
}

int NetCDFCpp::PutVara(string varname, vector<size_t> start, vector<size_t> count,
                       const long *data) {
    return (_PutVara(varname, start, count, (const void *)data, "nc_put_vara_long"));
}

int NetCDFCpp::PutVara(string varname, vector<size_t> start, vector<size_t> count,
                       const unsigned char *data) {
    return (_PutVara(varname, start, count, (const void *)data, "nc_put_vara_uchar"));
}
...
int NetCDFCpp::PutVar(string varname, const void *data) {
    return (_PutVar(varname, (const void *)data, "nc_put_var"));
}

int NetCDFCpp::PutVar(string varname, const float *data) {
    return (_PutVar(varname, (const void *)data, "nc_put_var_float"));
}

int NetCDFCpp::PutVar(string varname, const double *data) {
    return (_PutVar(varname, (const void *)data, "nc_put_var_double"));
}

int NetCDFCpp::PutVar(string varname, const int *data) {
    return (_PutVar(varname, (const void *)data, "nc_put_var_int"));
}

int NetCDFCpp::PutVar(string varname, const long *data) {
    return (_PutVar(varname, (const void *)data, "nc_put_var_long"));
}

int NetCDFCpp::PutVar(string varname, const unsigned char *data) {
    return (_PutVar(varname, (const void *)data, "nc_put_var_uchar"));
}

int NetCDFCpp::_GetVara(string varname, vector<size_t> start, vector<size_t> count, void *data,
                        string func) const {
    assert(start.size() == count.size());
...
int NetCDFCpp::GetVara(string varname, vector<size_t> start, vector<size_t> count,
                       void *data) const {
    return (_GetVara(varname, start, count, (void *)data, "nc_get_vara"));
}

int NetCDFCpp::GetVara(string varname, vector<size_t> start, vector<size_t> count,
                       float *data) const {
    return (_GetVara(varname, start, count, (void *)data, "nc_get_vara_float"));
}

int NetCDFCpp::GetVara(string varname, vector<size_t> start, vector<size_t> count,
                       double *data) const {
    return (_GetVara(varname, start, count, (void *)data, "nc_get_vara_double"));
}

int NetCDFCpp::GetVara(string varname, vector<size_t> start, vector<size_t> count,
                       int *data) const {
    return (_GetVara(varname, start, count, (void *)data, "nc_get_vara_int"));
}

int NetCDFCpp::GetVara(string varname, vector<size_t> start, vector<size_t> count,
                       long *data) const {
    return (_GetVara(varname, start, count, (void *)data, "nc_get_vara_long"));
}

int NetCDFCpp::GetVara(string varname, vector<size_t> start, vector<size_t> count,
                       unsigned char *data) const {
    return (_GetVara(varname, start, count, (void *)data, "nc_get_vara_uchar"));
}
...
int NetCDFCpp::GetVar(string varname, void *data) const {
    return (_GetVar(varname, (void *)data, "nc_get_var"));
}

int NetCDFCpp::GetVar(string varname, float *data) const {
    return (_GetVar(varname, (void *)data, "nc_get_var_float"));
}

int NetCDFCpp::GetVar(string varname, double *data) const {
    return (_GetVar(varname, (void *)data, "nc_get_var_double"));
}

int NetCDFCpp::GetVar(string varname, int *data) const {
    return (_GetVar(varname, (void *)data, "nc_get_var_int"));
}

int NetCDFCpp::GetVar(string varname, long *data) const {
    return (_GetVar(varname, (void *)data, "nc_get_var_long"));
}

int NetCDFCpp::GetVar(string varname, unsigned char *data) const {
    return (_GetVar(varname, (void *)data, "nc_get_var_uchar"));
}
