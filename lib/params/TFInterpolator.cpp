...
float TFInterpolator::XYZtransferMatrix[9] = {0.4124564, 0.2126729, 0.0193339, 0.3575761, 0.7151522,
...
void TFInterpolator::correctiveDivergentInterpolation(float rgb1[3], float rgb2[3], float output[3],
                                                      float interp) {
    divergentInterpolation(rgb1, rgb2, output, interp, true);
}

int TFInterpolator::divergentInterpolation(float rgb1[3], float rgb2[3], float output[3],
                                           float interp, bool corrective) {
