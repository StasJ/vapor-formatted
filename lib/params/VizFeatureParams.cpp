...
VizFeatureParams::VizFeatureParams(ParamsBase::StateSave *ssave)
    : ParamsBase(ssave, VizFeatureParams::GetClassType()) {

    _init();
}

VizFeatureParams::VizFeatureParams(ParamsBase::StateSave *ssave, XmlNode *node)
