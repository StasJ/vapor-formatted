...
IsoSurfaceParams::IsoSurfaceParams(DataMgr *dataManager, ParamsBase::StateSave *stateSave)
    : RayCasterParams(dataManager, stateSave, IsoSurfaceParams::GetClassType()) {}

IsoSurfaceParams::IsoSurfaceParams(DataMgr *dataManager, ParamsBase::StateSave *stateSave,
                                   XmlNode *xmlNode)
    : RayCasterParams(dataManager, stateSave, xmlNode) {
    if (xmlNode->GetTag() != IsoSurfaceParams::GetClassType()) {
        xmlNode->SetTag(IsoSurfaceParams::GetClassType());
    }
}
...
void IsoSurfaceParams::SetIsoValues(const std::vector<double> &vals) {
