...
ModelParams::ModelParams(DataMgr *dataMgr, ParamsBase::StateSave *ssave)
    : RenderParams(dataMgr, ssave, ModelParams::GetClassType(), 3) {
    SetDiagMsg("ModelParams::ModelParams() this=%p", this);
    _init();
}

ModelParams::ModelParams(DataMgr *dataMgr, ParamsBase::StateSave *ssave, std::string classType)
    : RenderParams(dataMgr, ssave, classType, 3) {
    SetDiagMsg("ModelParams::ModelParams() this=%p", this);
    _init();
}

ModelParams::ModelParams(DataMgr *dataMgr, ParamsBase::StateSave *ssave, XmlNode *node)
