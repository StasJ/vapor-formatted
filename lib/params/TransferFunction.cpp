...
// Constructor
//----------------------------------------------------------------------------
TransferFunction::TransferFunction(ParamsBase::StateSave *ssave)
    : MapperFunction(ssave, TransferFunction::GetClassType()) {}

TransferFunction::TransferFunction(ParamsBase::StateSave *ssave, XmlNode *node)
    : MapperFunction(ssave, node) {}

//----------------------------------------------------------------------------
// Destructor
//----------------------------------------------------------------------------
TransferFunction::~TransferFunction() {
    MyBase::SetDiagMsg("TransferFunction::~TransferFunction() this=%p", this);
}
