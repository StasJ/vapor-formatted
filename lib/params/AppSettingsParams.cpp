...
// Constructor
//----------------------------------------------------------------------------
AppSettingsParams::AppSettingsParams(ParamsBase::StateSave *ssave)
    : ParamsBase(ssave, m_classType) {
    _init();
}

AppSettingsParams::AppSettingsParams(ParamsBase::StateSave *ssave, XmlNode *node)
...
AppSettingsParams::~AppSettingsParams() {
    MyBase::SetDiagMsg("AppSettingsParams::~AppSettingsParams() this=%p", this);
}
