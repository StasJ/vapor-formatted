...
bool VolumeParams::GetLightingEnabled() const {
    return GetValueLong(_lightingEnabledTag, GetDefaultLightingEnabled());
}
void VolumeParams::SetPhongAmbient(float v) {
    SetValueDouble(_phongAmbientTag, "Phong ambient", v);
};
float VolumeParams::GetPhongAmbient() const {
    return GetValueDouble(_phongAmbientTag, GetDefaultPhongAmbient());
};
void VolumeParams::SetPhongDiffuse(float v) {
    SetValueDouble(_phongDiffuseTag, "Phong diffuse", v);
};
float VolumeParams::GetPhongDiffuse() const {
    return GetValueDouble(_phongDiffuseTag, GetDefaultPhongDiffuse());
};
void VolumeParams::SetPhongSpecular(float v) {
    SetValueDouble(_phongSpecularTag, "Phong specular", v);
};
float VolumeParams::GetPhongSpecular() const {
    return GetValueDouble(_phongSpecularTag, GetDefaultPhongSpecular());
};
void VolumeParams::SetPhongShininess(float v) {
    SetValueDouble(_phongShininessTag, "Phong shininess", v);
};
float VolumeParams::GetPhongShininess() const {
    return GetValueDouble(_phongShininessTag, GetDefaultPhongShininess());
};
