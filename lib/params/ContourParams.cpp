...
ContourParams::ContourParams(DataMgr *dataMgr, ParamsBase::StateSave *ssave)
...
ContourParams::ContourParams(DataMgr *dataMgr, ParamsBase::StateSave *ssave, XmlNode *node)
...
ContourParams::ContourParams(const ContourParams &rhs) : RenderParams(rhs) {
