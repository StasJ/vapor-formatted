...
int DCMPAS::_InitVerticalCoordinatesDerived(NetCDFCollection *ncdfc) {
    ...
    derivedVar = new DerivedCoordVertFromCell(zGridVertP1VarName, nVertLevelsP1DimName, this,
    ...
    derivedVar = new DerivedCoordVertFromCell(zGridVertVarName, nVertLevelsDimName, this,
