...
UnstructuredGrid::UnstructuredGrid(size_t topology_dimension, const std::vector<size_t> &node_dims,
                                   const std::vector<size_t> &cell_dims,
                                   const std::vector<size_t> &edge_dims,
                                   const std::vector<float *> &blks, const size_t *face_node_conn,
                                   const size_t *face_face_conn,
                                   Location location, // node,face, edge
                                   size_t max_nodes_per_face)
    : Grid(node_dims, topology_dimension) {
...
float *UnstructuredGrid::_AccessIndex(const std::vector<float *> &blks,
...
bool UnstructuredGrid::GetCellNodes(const std::vector<size_t> &cindices,
...
bool UnstructuredGrid::GetCellNeighbors(const std::vector<size_t> &cindices,
...
bool UnstructuredGrid::GetNodeCells(const std::vector<size_t> &indices,
                                    std::vector<vector<size_t>> &cells) const {
    cells.clear();
...
template <class T>
UnstructuredGrid::ForwardIterator<T>::ForwardIterator(T *rg, const vector<double> &minu,
...
#ifdef DEAD
template <class T>
UnstructuredGrid::ForwardIterator<T>::ForwardIterator(const ForwardIterator<T> &rhs) {
    _rg = rhs._rg;
...
template <class T> UnstructuredGrid::ForwardIterator<T>::ForwardIterator(ForwardIterator<T> &&rhs) {
    _rg = rhs._rg;
    rhs._rg = nullptr;
...
template <class T> UnstructuredGrid::ForwardIterator<T>::ForwardIterator() {
    _rg = nullptr;
    //_coordItr = xx;
    _x = 0;
    _y = 0;
...
template <class T>
UnstructuredGrid::ForwardIterator<T> &UnstructuredGrid::ForwardIterator<T>::operator++() {
...
#ifdef DEAD
template <class T>
UnstructuredGrid::ForwardIterator<T> UnstructuredGrid::ForwardIterator<T>::operator++(int) {
...
template <class T>
UnstructuredGrid::ForwardIterator<T> &
UnstructuredGrid::ForwardIterator<T>::operator+=(const long int &offset) {
...
template <class T>
UnstructuredGrid::ForwardIterator<T>
UnstructuredGrid::ForwardIterator<T>::operator+(const long int &offset) const {
...
template <class T>
bool UnstructuredGrid::ForwardIterator<T>::operator!=(
    const UnstructuredGrid::ForwardIterator<T> &other) {

    if (this->_end && other._end)
        return (false);

    return (!(this->_rg == other._rg && this->_xb == other._xb && this->_x == other._x &&
              this->_y == other._y && this->_z == other._z && this->_itr == other._itr &&
...
//
template <class T>
UnstructuredGrid::CellIterator<T>::CellIterator(T *sg, const vector<double> &minu,
                                                const vector<double> &maxu)
    : _pred(minu, maxu) {
...
template <class T>
UnstructuredGrid::ForwardCellIterator<T>::ForwardCellIterator(ForwardCellIterator<T> &&rhs) {
...
template <class T> UnstructuredGrid::ForwardCellIterator<T>::ForwardCellIterator() {
    _sg = nullptr;
    _dims.clear();
    _cellIndex.clear();
}
...
template <class T>
UnstructuredGrid::ForwardCellIterator<T> &UnstructuredGrid::ForwardCellIterator<T>::next2d() {
...
template <class T>
UnstructuredGrid::ForwardCellIterator<T> &UnstructuredGrid::ForwardCellIterator<T>::next3d() {
...
template <class T>
UnstructuredGrid::ForwardCellIterator<T> &UnstructuredGrid::ForwardCellIterator<T>::operator++() {
...
//
template <class T>
UnstructuredGrid::NodeIterator<T>::NodeIterator(T *sg, const vector<double> &minu,
                                                const vector<double> &maxu)
    : _pred(minu, maxu) {
...
template <class T>
UnstructuredGrid::ForwardNodeIterator<T>::ForwardNodeIterator(ForwardNodeIterator<T> &&rhs) {
...
template <class T> UnstructuredGrid::ForwardNodeIterator<T>::ForwardNodeIterator() {
    _sg = nullptr;
    _dims.clear();
    _nodeIndex.clear();
}
...
template <class T>
UnstructuredGrid::ForwardNodeIterator<T> &UnstructuredGrid::ForwardNodeIterator<T>::next2d() {
...
template <class T>
UnstructuredGrid::ForwardNodeIterator<T> &UnstructuredGrid::ForwardNodeIterator<T>::next3d() {
...
template <class T>
UnstructuredGrid::ForwardNodeIterator<T> &UnstructuredGrid::ForwardNodeIterator<T>::operator++() {
