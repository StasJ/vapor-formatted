...
bool LayeredGrid::GetIndicesCell(const std::vector<double> &coords,
                                 std::vector<size_t> &indices) const {
...
LayeredGrid::ConstCoordItrLayered::ConstCoordItrLayered(const LayeredGrid *lg, bool begin)
...
LayeredGrid::ConstCoordItrLayered::ConstCoordItrLayered(const ConstCoordItrLayered &rhs)
    : ConstCoordItrAbstract() {
    _index = rhs._index;
    _dims = rhs._dims;
    _minu = rhs._minu;
