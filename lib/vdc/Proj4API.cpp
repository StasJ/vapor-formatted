...
int Proj4API::_Transform(void *pjSrc, void *pjDst, double *x, double *y, double *z, size_t n,
                         int offset) const {

    // no-op
    //
    if (pjSrc == NULL || pjDst == NULL)
        return (0);
...
int Proj4API::Transform(double *x, double *y, double *z, size_t n, int offset) const {
...
int Proj4API::_Transform(void *pjSrc, void *pjDst, float *x, float *y, float *z, size_t n,
                         int offset) const {
    double *xd = NULL;
    double *yd = NULL;
    double *zd = NULL;
...
int Proj4API::Transform(float *x, float *y, float *z, size_t n, int offset) const {

    return (Proj4API::_Transform(_pjSrc, _pjDst, x, y, z, n, offset));
}

int Proj4API::Transform(string srcdef, string dstdef, double *x, double *y, double *z, size_t n,
                        int offset) const {
    void *pjSrc = NULL;
    void *pjDst = NULL;
...
int Proj4API::Transform(string srcdef, string dstdef, float *x, float *y, float *z, size_t n,
                        int offset) const {
    void *pjSrc = NULL;
    void *pjDst = NULL;
