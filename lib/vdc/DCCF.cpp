...
int DCCF::getDimLensAtLevel(string varname, int, std::vector<size_t> &dims_at_level,
...
template <class T>
int DCCF::_readRegionTemplate(const vector<size_t> &min, const vector<size_t> &max, T *region) {
...
bool DCCF::variableExists(size_t ts, string varname, int, int) const {
    return (_ncdfc->VariableExists(ts, varname));
}

int DCCF::_get_latlon_coordvars(NetCDFCFCollection *ncdfc, string dvar, string &loncvar,
...
int DCCF::_get_latlon_extents(NetCDFCFCollection *ncdfc, string latlon, bool lonflag, float &min,
                              float &max) {
...
int DCCF::_get_coord_pair_extents(NetCDFCFCollection *ncdfc, string lon, string lat, double &lonmin,
...
Proj4API *DCCF::_create_proj4api(double lonmin, double lonmax, double latmin, double latmax,
...
int DCCF::_InitHorizontalCoordinatesDerived(NetCDFCFCollection *ncdfc,
...
// is significant.
//
int DCCF::_GetVarCoordinates(NetCDFCFCollection *ncdfc, string varname, vector<string> &sdimnames,
...
//
DCCF::DerivedVarHorizontal::DerivedVarHorizontal(NetCDFCFCollection *ncdfc, string lonname,
                                                 string latname, const vector<DC::Dimension> &dims,
...
int DCCF::DerivedVarHorizontal::ReadSlice(float *slice, int) {
