...
bool UDUnits::IsLatUnit(string unitstr) const {
    ...
    //
    if (!((unitstr.compare("degrees_north") == 0) || (unitstr.compare("degree_north") == 0) ||
          (unitstr.compare("degree_N") == 0) || (unitstr.compare("degrees_N") == 0) ||
...
bool UDUnits::IsLonUnit(string unitstr) const {
    ...
    // below is probably all that is needed for this method.
    //
    if (!((unitstr.compare("degrees_east") == 0) || (unitstr.compare("degree_east") == 0) ||
          (unitstr.compare("degree_E") == 0) || (unitstr.compare("degrees_E") == 0) ||
...
bool UDUnits::IsLatOrLonUnit(string unitstr) const {
    return (AreUnitsConvertible(_lonUnit, unitstr) || AreUnitsConvertible(_latUnit, unitstr));
}
...
bool UDUnits::Convert(const string from, const string to, const float *src, float *dst,
                      size_t n) const {
...
bool UDUnits::Convert(const string from, const string to, const double *src, double *dst,
                      size_t n) const {
...
void UDUnits::DecodeTime(double seconds, int *year, int *month, int *day, int *hour, int *minute,
                         int *second) const {
...
double UDUnits::EncodeTime(int year, int month, int day, int hour, int minute, int second) const {
