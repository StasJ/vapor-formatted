...
UnstructuredGridLayered::UnstructuredGridLayered(
    ...
    size_t maxVertexPerFace, size_t maxFacePerVertex, const UnstructuredGridCoordless &xug,
    ...
    : UnstructuredGrid(vertexDims, faceDims, edgeDims, bs, blks, 3, vertexOnFace, faceOnVertex,
      ...
      _ug2d(vector<size_t>{vertexDims[0]}, vector<size_t>{faceDims[0]},
            ...
            blks, vertexOnFace, faceOnVertex, faceOnFace, location, maxVertexPerFace,
...
void UnstructuredGridLayered::GetEnclosingRegion(const vector<double> &minu,
...
void UnstructuredGridLayered::GetUserCoordinates(const std::vector<size_t> &indices,
...
void UnstructuredGridLayered::GetIndices(const std::vector<double> &coords,
