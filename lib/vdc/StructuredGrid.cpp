...
StructuredGrid::ConstNodeIteratorSG::ConstNodeIteratorSG(const StructuredGrid *rg, bool begin)
...
StructuredGrid::ConstNodeIteratorSG::ConstNodeIteratorSG(const ConstNodeIteratorSG &rhs)
    : ConstNodeIteratorAbstract() {
    _dims = rhs._dims;
    _index = rhs._index;
...
StructuredGrid::ConstNodeIteratorBoxSG::ConstNodeIteratorBoxSG(const StructuredGrid *rg,
...
StructuredGrid::ConstNodeIteratorBoxSG::ConstNodeIteratorBoxSG(const ConstNodeIteratorBoxSG &rhs)
    : ConstNodeIteratorSG() {
...
StructuredGrid::ConstCellIteratorSG::ConstCellIteratorSG(const StructuredGrid *rg, bool begin)
...
StructuredGrid::ConstCellIteratorSG::ConstCellIteratorSG(const ConstCellIteratorSG &rhs)
    : ConstCellIteratorAbstract() {
    _dims = rhs._dims;
    _index = rhs._index;
    _lastIndex = rhs._lastIndex;
...
StructuredGrid::ConstCellIteratorBoxSG::ConstCellIteratorBoxSG(const StructuredGrid *rg,
                                                               const std::vector<double> &minu,
                                                               const std::vector<double> &maxu)
...
StructuredGrid::ConstCellIteratorBoxSG::ConstCellIteratorBoxSG(const ConstCellIteratorBoxSG &rhs)
    : ConstCellIteratorSG() {
    _coordItr = rhs._coordItr;
    _pred = rhs._pred;
}
