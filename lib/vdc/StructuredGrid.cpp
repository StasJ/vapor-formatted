...
StructuredGrid::ConstNodeIteratorSG::ConstNodeIteratorSG(const StructuredGrid *rg,
...
StructuredGrid::ConstCellIteratorSG::ConstCellIteratorSG(const StructuredGrid *rg, bool begin)
    ...
    _index = vector<size_t>(_dims.size(), 0);
    if (!begin) {
        _index[_dims.size() - 1] = _dims[_dims.size() - 1] - 1;
    }
}

StructuredGrid::ConstCellIteratorSG::ConstCellIteratorSG(const StructuredGrid *rg,
                                                         const std::vector<double> &minu,
                                                         const std::vector<double> &maxu)
    : ConstCellIteratorAbstract() {
    assert(0 && "Not supported");
