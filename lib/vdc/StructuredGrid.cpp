...
StructuredGrid::ConstNodeIteratorRG::ConstNodeIteratorRG(const StructuredGrid *rg, bool begin)
...
StructuredGrid::ConstNodeIteratorRG::ConstNodeIteratorRG(const StructuredGrid *rg,
...
StructuredGrid::ConstNodeIteratorRG::ConstNodeIteratorRG(const ConstNodeIteratorRG &rhs)
    : ConstNodeIteratorAbstract() {
    _dims = rhs._dims;
    _nodeIndex = rhs._nodeIndex;
}

StructuredGrid::ConstNodeIteratorRG::ConstNodeIteratorRG() : ConstNodeIteratorAbstract() {
