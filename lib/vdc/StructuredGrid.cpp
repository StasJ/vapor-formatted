...
void StructuredGrid::_StructuredGrid(const vector<size_t> &dims, const vector<size_t> &bs,
...
StructuredGrid::StructuredGrid(const vector<size_t> &dims, const vector<size_t> &bs,
                               const vector<float *> &blks)
    : Grid(dims, dims.size()) {
...
float *StructuredGrid::_AccessIndex(const std::vector<float *> &blks,
...
bool StructuredGrid::GetCellNodes(const std::vector<size_t> &cindices,
...
bool StructuredGrid::GetCellNeighbors(const std::vector<size_t> &cindices,
...
bool StructuredGrid::GetNodeCells(const std::vector<size_t> &indices,
                                  std::vector<vector<size_t>> &cells) const {
    cells.clear();
...
template <class T>
StructuredGrid::ForwardIterator<T>::ForwardIterator(T *rg, const vector<double> &minu,
...
#ifdef DEAD
template <class T>
StructuredGrid::ForwardIterator<T>::ForwardIterator(const ForwardIterator<T> &rhs) {
    _rg = rhs._rg;
...
template <class T>
StructuredGrid::ForwardIterator<T> &
StructuredGrid::ForwardIterator<T>::operator=(ForwardIterator<T> rhs) {
...
template <class T>
StructuredGrid::ForwardIterator<T> &StructuredGrid::ForwardIterator<T>::operator++() {
...
#ifdef DEAD
template <class T>
StructuredGrid::ForwardIterator<T> StructuredGrid::ForwardIterator<T>::operator++(int) {
...
template <class T>
StructuredGrid::ForwardIterator<T> &
StructuredGrid::ForwardIterator<T>::operator+=(const long int &offset) {
...
template <class T>
StructuredGrid::ForwardIterator<T>
StructuredGrid::ForwardIterator<T>::operator+(const long int &offset) const {
...
template <class T>
bool StructuredGrid::ForwardIterator<T>::operator!=(
    const StructuredGrid::ForwardIterator<T> &other) {
...
//
template <class T>
StructuredGrid::CellIterator<T>::CellIterator(T *sg, const vector<double> &minu,
                                              const vector<double> &maxu)
    : _pred(minu, maxu) {
...
template <class T>
StructuredGrid::ForwardCellIterator<T>::ForwardCellIterator(ForwardCellIterator<T> &&rhs) {
...
template <class T>
StructuredGrid::ForwardCellIterator<T> &StructuredGrid::ForwardCellIterator<T>::next2d() {
...
template <class T>
StructuredGrid::ForwardCellIterator<T> &StructuredGrid::ForwardCellIterator<T>::next3d() {
...
template <class T>
StructuredGrid::ForwardCellIterator<T> &StructuredGrid::ForwardCellIterator<T>::operator++() {
...
//
template <class T>
StructuredGrid::NodeIterator<T>::NodeIterator(T *sg, const vector<double> &minu,
                                              const vector<double> &maxu)
    : _pred(minu, maxu) {
...
template <class T>
StructuredGrid::ForwardNodeIterator<T>::ForwardNodeIterator(ForwardNodeIterator<T> &&rhs) {
...
template <class T>
StructuredGrid::ForwardNodeIterator<T> &StructuredGrid::ForwardNodeIterator<T>::next2d() {
...
template <class T>
StructuredGrid::ForwardNodeIterator<T> &StructuredGrid::ForwardNodeIterator<T>::next3d() {
...
template <class T>
StructuredGrid::ForwardNodeIterator<T> &StructuredGrid::ForwardNodeIterator<T>::operator++() {
