...
int VDCNetCDF::Initialize(const vector<string> &paths, AccessMode mode, size_t chunksizehint) {
...
int VDCNetCDF::GetVar(size_t ts, string varname, int level, int lod, float *data) {
    return (_GetVar(ts, varname, level, lod, data));
}

int VDCNetCDF::GetVar(size_t ts, string varname, int level, int lod, int *data) {
    return (_GetVar(ts, varname, level, lod, data));
}
