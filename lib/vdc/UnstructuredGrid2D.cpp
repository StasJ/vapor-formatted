...
bool UnstructuredGrid2D::_insideFace(size_t face, double pt[2], vector<size_t> &node_indices,
                                     double *lambda, int &nlambda) const {
    node_indices.clear();
    nlambda = 0;
...
std::shared_ptr<QuadTreeRectangle<float, size_t>>
UnstructuredGrid2D::_makeQuadTreeRectangle() const {
