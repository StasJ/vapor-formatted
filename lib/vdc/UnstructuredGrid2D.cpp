...
UnstructuredGrid2D::UnstructuredGrid2D(const std::vector<size_t> &vertexDims,
    ...
    : UnstructuredGrid(vertexDims, faceDims, edgeDims, bs, blks, 2, vertexOnFace, faceOnVertex,
...
UnstructuredGrid2D::ConstCoordItrU2D::ConstCoordItrU2D(const ConstCoordItrU2D &rhs)
    : ConstCoordItrAbstract() {
...
//
bool UnstructuredGrid2D::_insideGrid(const vector<double> &coords, vector<size_t> &face_indices,
...
bool UnstructuredGrid2D::_insideGridFaceCentered(const vector<double> &coords,
...
bool UnstructuredGrid2D::_insideGridNodeCentered(const vector<double> &coords,
                                                 vector<size_t> &face_indices, double *lambda,
                                                 int &nlambda, double zwgt[2]) const {
    face_indices.clear();
...
bool UnstructuredGrid2D::_insideFace(size_t face, double pt[2], double *lambda, int &nlambda,
                                     double zwgt[2]) const {
    nlambda = 0;
