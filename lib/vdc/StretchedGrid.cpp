...
StretchedGrid::StretchedGrid(const size_t bs[3], const size_t min[3], const size_t max[3],
                             const double extents[6], const bool periodic[3], float **blks,
                             const vector<double> &xcoords, const vector<double> &ycoords,
...
StretchedGrid::StretchedGrid(const size_t bs[3], const size_t min[3], const size_t max[3],
                             const double extents[6], const bool periodic[3], float **blks,
                             const vector<double> &xcoords, const vector<double> &ycoords,
                             const vector<double> &zcoords, float missing_value)
...
int StretchedGrid::GetUserCoordinates(size_t i, size_t j, size_t k, double *x, double *y,
                                      double *z) const {
...
void StretchedGrid::GetBoundingBox(const size_t min[3], const size_t max[3],
                                   double extents[6]) const {
    StretchedGrid::GetUserCoordinates(min[0], min[1], min[2], &(extents[0]), &(extents[1]),
                                      &(extents[2]));
    StretchedGrid::GetUserCoordinates(max[0], max[1], max[2], &(extents[3]), &(extents[4]),
                                      &(extents[5]));
}

void StretchedGrid::GetEnclosingRegion(const double minu[3], const double maxu[3], size_t min[3],
                                       size_t max[3]) const {
    ...
    StretchedGrid::GetUserCoordinates(temp_min[0], temp_min[1], temp_min[2], &temp_minu[0],
                                      &temp_minu[1], &temp_minu[2]);
    StretchedGrid::GetUserCoordinates(temp_max[0], temp_max[1], temp_max[2], &temp_maxu[0],
...
void StretchedGrid::GetIJKIndex(double x, double y, double z, size_t *i, size_t *j,
                                size_t *k) const {
...
void StretchedGrid::GetIJKIndexFloor(double x, double y, double z, size_t *i, size_t *j,
                                     size_t *k) const {
