...
bool STLUtils::ContainsIgnoreCase(const std::string &toSearch, const std::string &query) {
    return Contains(ToLower(toSearch), ToLower(query));
}
...
std::string STLUtils::ReplaceAll(std::string source, const std::string &oldSegment,
