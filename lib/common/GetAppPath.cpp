...
std::string Wasp::GetAppPath(const string &app, const string &resource, const vector<string> &paths,
    ...
    if (!((myResource.compare("lib") == 0) || (myResource.compare("bin") == 0) ||
          (myResource.compare("share") == 0) || (myResource.compare("plugins") == 0) ||
          (myResource.compare("home") == 0) || (myResource.compare("") == 0))) {
