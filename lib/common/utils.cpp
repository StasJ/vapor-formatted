...
size_t Wasp::LinearizeCoords(const std::vector<size_t> &coords, const std::vector<size_t> &min,
...
void Wasp::VectorizeCoords(size_t offset, const size_t *min, const size_t *max, size_t *coords,
                           int n) {
...
std::vector<size_t> Wasp::VectorizeCoords(size_t offset, const std::vector<size_t> &min,
                                          const std::vector<size_t> &max) {
...
vector<size_t> Wasp::IncrementCoords(const vector<size_t> &min, const vector<size_t> &max,
                                     vector<size_t> counter, int dim) {
    VAssert(min.size() == max.size());
...
void Wasp::Transpose(const float *a, float *b, size_t p1, size_t m1, size_t s1, size_t p2,
                     size_t m2, size_t s2) {
    size_t I1, I2;
    size_t i1, i2;
    size_t q, r;
