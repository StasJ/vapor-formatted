...
//
size_t Wasp::LinearizeCoords(const vector<size_t> &coords, const vector<size_t> &min,
...
vector<size_t> Wasp::VectorizeCoords(size_t offset, const vector<size_t> &min,
                                     const vector<size_t> &max) {
    assert(min.size() == max.size());
