...
void Renderer::renderColorbarText(ColorbarPbase *cbpb, float fbWidth, float fbHeight, float llx,
    ...
    for (int tic = 0; tic < numtics; tic++) {
        ...
        _textObject->Initialize("/Users/pearse/Downloads/pacifico/Pacifico.ttf", textString, 20,
    ...
    if (title != "") {
        ...
        txtColor[3] = 1.f;
        _textObject = new TextObject();
        _textObject->Initialize("/Users/pearse/Downloads/pacifico/Pacifico.ttf", title, 20, dummy,
                                0, txtColor, bgColor);
