...
Renderer::Renderer(const ParamsMgr *pm, string winName, string paramsType, string classType,
...
RendererBase::RendererBase(const ParamsMgr *pm, string winName, string paramsType, string classType,
                           string instName, DataStatus *ds) {
    // Establish the data sources for the rendering:
    //
    m_pm = pm;
...
Renderer *RendererFactory::CreateInstance(const ParamsMgr *pm, string winName, string classType,
                                          string instName, DataStatus *ds) {
