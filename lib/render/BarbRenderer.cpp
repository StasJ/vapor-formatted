...
//
void BarbRenderer::_drawBarb(const std::vector<Grid *> variableData, const float startPoint_[3],
                             bool doColorMapping, const float clut[1024]) {
    float startPoint[3];
...
bool BarbRenderer::_defineBarb(const std::vector<Grid *> variableData, float start[3], float end[3],
                               bool doColorMapping, const float clut[1024]) {
    bool missing = false;
