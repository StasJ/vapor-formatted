...
void TranslateStretchManip::removeRotation(vector<double> rotations, vector<double> origins,
                                           double extents[6]) {
...
void TranslateStretchManip::applyRotation(vector<double> rotations, vector<double> origins,
                                          double extents[6]) {
    ...
    // cout << "X " << a << " " << extents[4] << " " << cos(rotations[0]) << " " << rotations[0] <<
    // " " << origins[1] << endl;
