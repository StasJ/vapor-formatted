...
RayCaster::RayCaster(const ParamsMgr *pm, std::string &winName, std::string &dataSetName,
    ...
    : Renderer(pm, winName, dataSetName, paramsType, classType, instName, dataMgr),
      ...
      _missingValueTexOffset(4), _zCoordsTexOffset(5), _xyCoordsTexOffset(6), _depthTexOffset(7) {
            ...
            for (size_t x = 0; x < dims[0]; x++) {
                ...
                */
                ...
                if (x < dims[0] - 1) {
                    ...
                    e1 = v1 - v2;
                    e2 = v3 - v2 if (glm::dot(e1, e2) >
                                     0.0f) // Need to find the height from v1 to edge v3v2
                    {
