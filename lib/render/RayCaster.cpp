...
int RayCaster::_paintGL(bool fast) {
    ...
    glCopyTexImage2D(GL_TEXTURE_2D, 0, GL_DEPTH_COMPONENT, _currentViewport[0], _currentViewport[1],
                     _currentViewport[2], _currentViewport[3], 0);
...
void RayCaster::_load3rdPassUniforms(long castingMode, const glm::mat4 &inversedMV,
                                     bool fast) const {
    ...
    float span[3] = {boxmaxEye[0] - boxminEye[0], boxmaxEye[1] - boxminEye[1],
