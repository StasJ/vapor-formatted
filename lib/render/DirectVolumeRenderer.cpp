...
int DirectVolumeRenderer::_paintGL() {
    ...
    _drawVolumeFaces(_cacheParams.userCoords.frontFace, _cacheParams.userCoords.backFace,
                     _cacheParams.userCoords.rightFace, _cacheParams.userCoords.leftFace,
                     _cacheParams.userCoords.topFace, _cacheParams.userCoords.bottomFace,
                     _cacheParams.boxMin.data(), _cacheParams.boxMax.data(),
                     _cacheParams.userCoords.dims, true);
...
void DirectVolumeRenderer::_saveCacheParams(bool considerUserCoordinates) {
    ...
    if (considerUserCoordinates) {
        VAPoR::StructuredGrid *grid = dynamic_cast<VAPoR::StructuredGrid *>(
            _dataMgr->GetVariable(_cacheParams.ts, _cacheParams.varName, _cacheParams.level,
...
void DirectVolumeRenderer::_initializeTextures() {
    ...
    glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, _baskFaceTextureId,
                           0);
...
void DirectVolumeRenderer::_drawVolumeFaces(const float *frontFace, const float *backFace,
    ...
    float volumeSpanInverse[3] = {1.0f / static_cast<float>(volumeMax[0] - volumeMin[0]),
                                  1.0f / static_cast<float>(volumeMax[1] - volumeMin[1]),
...
GLuint DirectVolumeRenderer::LoadShaders(const char *vertex_file_path,
