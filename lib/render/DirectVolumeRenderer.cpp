...
int DirectVolumeRenderer::_paintGL() {
    ...
    _drawVolumeFaces(_cache.userCoords.frontFace, _cache.userCoords.backFace,
                     _cache.userCoords.rightFace, _cache.userCoords.leftFace,
                     _cache.userCoords.topFace, _cache.userCoords.bottomFace, _cache.boxMin,
                     _cache.boxMax, _cache.userCoords.dims,
                     1); // The 1st pass!!!
...
void DirectVolumeRenderer::_saveCacheParams(bool considerUserCoordinates) {
    ...
    if (considerUserCoordinates) {
        VAPoR::StructuredGrid *grid = dynamic_cast<VAPoR::StructuredGrid *>(_dataMgr->GetVariable(
            _cache.ts, _cache.varName, _cache.level, _cache.lod, extMin, extMax));
        if (grid != nullptr) {
