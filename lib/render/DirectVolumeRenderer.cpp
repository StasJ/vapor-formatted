...
int DirectVolumeRenderer::_paintGL() {
    ...
    _drawVolumeFaces(_cacheParams.userCoords.frontFace, _cacheParams.userCoords.backFace,
                     ...
                     _cacheParams.boxMin, _cacheParams.boxMax, _cacheParams.userCoords.dims,
                     1); // The 1st pass!!!
    ...
    if (considerUserCoordinates) {
        VAPoR::StructuredGrid *grid = dynamic_cast<VAPoR::StructuredGrid *>(
            _dataMgr->GetVariable(_cacheParams.ts, _cacheParams.varName, _cacheParams.level,
                                  _cacheParams.lod, extMin, extMax));
        if (grid != nullptr) {
...
void DirectVolumeRenderer::_drawQuad() {
    const GLfloat quadVertices[] = {
        _cacheParams.boxMin[0], _cacheParams.boxMax[1], _cacheParams.boxMin[2],
