...
void VizFeatureRenderer::DrawText(vector<billboard> billboards) {
    ...
    for (int i = 0; i < billboards.size(); i++) {
        ...
        _textObject->Initialize(_fontFile, text, size, coords, TextObject::LABEL, txtColor,
                                bgColor);
...
void VizFeatureRenderer::renderText(double llx, double lly) {
    ...
    _textObject->Initialize(_fontFile, textString, fontSize, dummy, TextObject::BILLBOARD, txtColor,
                            bgColor, vpParams);
