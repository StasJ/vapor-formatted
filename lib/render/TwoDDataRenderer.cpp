...
TwoDDataRenderer::TwoDDataRenderer(const ParamsMgr *pm, string winName, string instName,
                                   DataStatus *ds)
    : TwoDRenderer(pm, winName, TwoDDataParams::GetClassType(), TwoDDataRenderer::GetClassType(),
                   instName, ds) {
