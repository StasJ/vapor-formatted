...
bool TwoDDataRenderer::_gridStateDirty() const {
    ...
    _grid_state_c current_state(rParams->GetRefinementLevel(), rParams->GetCompressionLevel(),
...
void TwoDDataRenderer::_gridStateSet() {
    ...
    cout << "minEx: " << _currentBoxMinExts[0] << " " << _currentBoxMinExts[1] << " "
         << _currentBoxMinExts[2] << endl;
    cout << "maxEx: " << _currentBoxMaxExts[0] << " " << _currentBoxMaxExts[1] << " "
         << _currentBoxMaxExts[2] << endl;
}
