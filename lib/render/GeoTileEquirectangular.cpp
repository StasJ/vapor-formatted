...
void GeoTileEquirectangular::LatLongToPixelXY(double lon, double lat, int lod, size_t &pixelX,
                                              size_t &pixelY) const {
...
void GeoTileEquirectangular::PixelXYToLatLon(size_t pixelX, size_t pixelY, int lod, double &lon,
                                             double &lat) const {
