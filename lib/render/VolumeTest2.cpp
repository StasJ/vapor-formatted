...
static void GetFaceVertices(const ivec3 &cellIndex, const ivec3 &face, const vec3 *data,
...
static void GetFaceVertices(const ivec3 &cellIndex, int face, const vec3 *data, const ivec3 &dims,
...
static bool IsInsideCell(const vec3 &p, const ivec3 &cellIndex, const vec3 *coords,
                         const ivec3 dims) {
