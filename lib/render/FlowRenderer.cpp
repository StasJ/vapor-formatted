...
show_dir_loop:
    ...
    //    shader->SetUniform("phongAmbient", (float)rp->GetValueDouble(FlowParams::PhongAmbientTag,
    //    0)); shader->SetUniform("phongDiffuse",
    //    (float)rp->GetValueDouble(FlowParams::PhongDiffuseTag, 0));
    //    shader->SetUniform("phongSpecular",
    //    (float)rp->GetValueDouble(FlowParams::PhongSpecularTag, 0));
