...
JPGWriter::JPGWriter(const std::string &path)
    : ImageWriter(path), fp(nullptr), Quality(DefaultQuality) {
...
int JPGWriter::Write(const unsigned char *buffer, const unsigned int width,
