...
int ModelRenderer::_paintGL(bool fast) {
    ...
    const std::string file =
        rp->GetValueString("file", "/Users/stasj/Developer/data/Rotating_Box_Color.dae");
...
int ModelRenderer::loadFile(const std::string &path) {
    ...
    scene = importer.ReadFile(path, aiProcessPreset_TargetRealtime_Quality | aiProcess_Triangulate);
