...
int TextObject::Initialize(string font, string text, int size, vector<double> txtColor,
                           vector<double> bgColor, ViewpointParams *vpParams, TypeFlag type,
    ...
    float txtColorArray[] = {(float)txtColor[0], (float)txtColor[1], (float)txtColor[2],
                             (float)txtColor[3]};
    float bgColorArray[] = {(float)bgColor[0], (float)bgColor[1], (float)bgColor[2],
                            (float)bgColor[3]};

    return Initialize(font, text, size, txtColorArray, bgColorArray, vpParams, type, orientation);
}

int TextObject::Initialize(string font, string text, int size, double txtColor[4],
                           double bgColor[4], ViewpointParams *vpParams, TypeFlag type,
                           OrientationFlag orientation) {
...
int TextObject::Initialize(string font, string text, int size, float txtColor[4], float bgColor[4],
                           ViewpointParams *vpParams, TypeFlag type, OrientationFlag orientation) {
    cout << "					txtColor " << txtColor[0] << " " << txtColor[1] << " "
         << txtColor[2] << " " << txtColor[3] << endl;
    cout << "					bgColor " << bgColor[0] << " " << bgColor[1] << " " << bgColor[2]
         << " " << bgColor[3] << endl;
...
int TextObject::initFrameBuffer(void) {
    ...
    //	glGetDoublev(GL_COLOR_CLEAR_VALUE,bgColors);
    //	glGetDoublev(GL_CURRENT_COLOR,txColors);
    cout << "bg: " << _bgColor[0] << " " << _bgColor[1] << " " << _bgColor[2] << " " << _bgColor[3]
         << endl;
    //	cout << "bg: " << bgColors[0] << " " << bgColors[1] << " " << bgColors[2] << " " <<
    //bgColors[3] << endl << endl;
    cout << "tx: " << _txtColor[0] << " " << _txtColor[1] << " " << _txtColor[2] << " "
         << _txtColor[3] << endl;
    //	cout << "tx: " << txColors[0] << " " << txColors[1] << " " << txColors[2] << " " <<
    //txColors[3] << endl;
    ...
    //	cout << "ag: " << bgColor[0] << " " << bgColor[1] << " " << bgColor[2] << " " << bgColor[3]
    //<< endl; 	cout << "ax: " << txtColor[0] << " " << txtColor[1] << " " << txtColor[2] << " " <<
    //txtColor[3] << endl; 	cout << endl;
...
int TextObject::drawMe(double coords[3]) {
    ...
    double bgColors[4];
    glGetDoublev(GL_COLOR_CLEAR_VALUE, bgColors);
    cout << "drawME " << bgColors[0] << " " << bgColors[1] << " " << bgColors[2] << " "
         << bgColors[3] << endl;
