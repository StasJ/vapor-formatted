...
TextContainer::TextContainer(string fontFile, int fontSize, float txtColor[4], float bgColor[4],
                             int type) {
...
int TextObject::Initialize(string inFont, string inText, int inSize, float inCoords[3], int inType,
                           float txtColor[4], float bgColor[4]) {
