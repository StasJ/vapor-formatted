...
int HelloRenderer::_paintGL(bool) {
    ...
    // Finally, obtain the Grid of the data for the specified region, at requested refinement and
    // lod, using Renderer::getGrids()
    size_t timestep = rParams->GetCurrentTimestep();

    int rc = DataMgrUtils::GetGrids(_dataMgr, timestep, varname, point1, point2, true,
