...
void AnnotationRenderer::applyTransform(Transform *t) {
    ...
    _glManager->matrixManager->Translate(
        origin[0], origin[1], origin[2]); // glTranslatef(origin[0], origin[1], origin[2]);
    _glManager->matrixManager->Scale(scale[0], scale[1],
                                     scale[2]); // glScalef(scale[0], scale[1], scale[2]);
    ...
    _glManager->matrixManager->Translate(
        ...
        translate[2]); // glTranslatef(translate[0], translate[1], translate[2]);
